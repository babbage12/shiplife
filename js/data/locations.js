const locations = [
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/toledo/sweater_kid" class="story-image" data-caption="Different drummer, different dress code." alt="Sweater across the back" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/lespaujr_uhaklg" class="story-image" data-caption="My mom's '61 Gibson SG. I dreamed of holding it. Then I sold it." alt="1961 Gibson SG" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">

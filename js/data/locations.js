const locations = [
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/toledo/me_as_a_kid" class="story-image" data-caption="Uncomfortable." alt="Me as a kid" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/lespaujr_uhaklg" class="inline-image" data-caption="My mom's '61 Gibson SG. I dreamed of holding it. Then I sold it." alt="1961 Gibson SG" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/toledo/sweater_kid" class="inline-image" data-caption="Different drummer, different dress code." alt="On stage with the SG" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <p>I left work early that day and was packing before the next day was over. Everything I had went into a storage unit. A few weeks later, I was boarding a plane on my way to eventually Australia, where the next chapter was waiting to be written.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1772321183/shiplife/brisbane/smugglers-crowd-dancing.png" class="story-image" alt="Smugglers Lounge with dancing crowd" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770827962/shiplife/brisbane/yvkbyzev0b4wz8f1dkcf.jpg" class="story-image" alt="Brisbane" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770827967/shiplife/brisbane/vkrugky6hmspuwkhz1w3.jpg" class="story-image" alt="Brisbane exploration" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1769816317/brisbane_iajcgd.jpg" class="story-image" alt="Brisbane, Australia" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The door stayed open.</p>
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Brisbane' : '+ More about Brisbane'">+ More about Brisbane</p>
 <div class="more-info-content">
 <p><strong>River City:</strong> Brisbane wraps around a winding river that snakes through the city center. The Brisbane River defines the city's geography and culture.</p>
 <p><strong>BrisVegas:</strong> Locals affectionately call it "BrisVegas." The nickname started as a joke about the city being boring, but Brisbanites embraced it with pride.</p>
 <p><strong>Story Bridge:</strong> The iconic Story Bridge was hand-built during the Great Depression, providing jobs when they were desperately needed. You can now climb it for panoramic views.</p>
 <p><strong>Subtropical Paradise:</strong> Brisbane enjoys over 280 days of sunshine per year. The subtropical climate means outdoor living is a way of life.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768526570/IMG_0109_dvahoj.jpg" class="story-image" data-caption="Pacific Sun docked in New Caledonia." alt="Pacific Sun in New Caledonia" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768526487/Isle_of_Pines_tddsqy.jpg" class="story-image" data-caption="Isle of Pines, New Caledonia." alt="Isle of Pines" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768526493/134_cwcuy0.jpg" class="story-image" data-caption="Pool party in Bali." alt="Pool party in Bali" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">Isle of Pines, New Caledonia. Pool party in Bali.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768526496/bora_bora_z03zsr.jpg" class="story-image" data-caption="Bora Bora, French Polynesia." alt="Bora Bora" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768527359/DSC00357_et8mzd.jpg" class="story-image" data-caption="Semarang temple, Indonesia." alt="Semarang temple" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">Bora Bora, French Polynesia. Semarang temple, Indonesia.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1767645531/darwin_star_jseq6c.jpg" class="story-image" data-caption="The Star Picture Theatre in Darwin." alt="Darwin Star Picture Theatre" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1767645531/DSC00286_ikuq8x.jpg" class="story-image" data-caption="Brisbane lit up at night." alt="Brisbane at night" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/litchfield/031.jpg" class="story-image" data-caption="Litchfield" alt="Litchfield" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/litchfield/039.jpg" class="story-image" data-caption="Litchfield waterfalls" alt="Litchfield" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/litchfield/040.jpg" class="story-image" data-caption="Litchfield" alt="Litchfield" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/litchfield/049.jpg" class="story-image" data-caption="Litchfield swimming hole" alt="Litchfield" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/litchfield/053.jpg" class="story-image" data-caption="The crocodile-infested waters we were swimming in" alt="Litchfield" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 </details>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768528813/Screen_Shot_2026-01-15_at_9.00.59_PM_i6usqj.png" class="story-image" data-caption="Hayden and I performing in Atlantis Lounge." alt="Hayden and I in Atlantis" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768528773/Screen_Shot_2026-01-15_at_9.00.21_PM_ood4z7.png" class="story-image" data-caption="Hayden and I performing in Atlantis Lounge." alt="Hayden and I in Atlantis" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">Hayden and I performing in Atlantis Lounge.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768528580/Screen_Shot_2026-01-15_at_8.57.09_PM_eibhfs.png" class="story-image" data-caption="Playing with my friend Lars in Smugglers Lounge." alt="Playing with Lars" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Playing with my friend Lars in Smugglers Lounge.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768531847/008-3_zkgv14.jpg" class="story-image" data-caption="Aussie passengers know how to party." alt="Aussie passengers know how to party" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768531863/011-6_t1i6uf.jpg" class="story-image" data-caption="Aussie passengers know how to party." alt="Aussie passengers know how to party" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768530034/Screen_Shot_2026-01-15_at_9.21.22_PM_kazerc.png" class="story-image" data-caption="Cruise Director's Corner. Where do hands go? What are hands? Why do I have hands?" alt="TV show nervous" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1767729034/IMG_0169_nnzkhu.jpg" class="story-image" alt="Leaving Auckland" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769827243/seabourn_in_marseille_w6uyqy.jpg" class="story-image" alt="Seabourn in Marseille" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769827154/seabourn_in_amalfi_zxkxez.jpg" class="story-image" alt="Seabourn in Amalfi" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769825370/seabourn_goes_anywhere_it_wants_rlcqhm.jpg" class="story-image" alt="Seabourn goes anywhere" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769825251/oddyssy_in_malta_ozbqnz.jpg" class="story-image" alt="Seabourn Odyssey in Malta" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769825070/seabourn_sezzq5.jpg" class="story-image" alt="Seabourn ship" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769824723/sojourn_2_jajz31.jpg" class="story-image" alt="Seabourn Sojourn" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/maldives/hammock-cropped" class="story-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/hammock-cropped" data-caption="Island life" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0079-2" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0079-2" data-caption="The dock" alt="Dock" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0079-2')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0080-2" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0080-2" data-caption="Arrival" alt="Arrival" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0080-2')" style="cursor:pointer">
 </div>
 <div class="image-row image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0081" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0081" data-caption="Into the jungle" alt="Jungle dock" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0081')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0083-2" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0083-2" data-caption="Welcome to Reithi Rah" alt="Welcome" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0083-2')" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/maldives/img_0076" class="story-image" data-caption="My jungle house" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <div class="image-row image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0149" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0149" data-caption="View from bed" alt="Jungle home" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0149')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0156" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0156" data-caption="The deck" alt="Deck" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0156')" style="cursor:pointer">
 </div>
 <div class="image-row image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0010" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0010" data-caption="Jungle home" alt="Jungle home" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0010')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0154" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0154" data-caption="Jungle home" alt="Jungle home" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0154')" style="cursor:pointer">
 </div>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/maldives/img_0042" class="story-image" data-caption="Guitar on the beach" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <div class="image-row image-row-3">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/maldives/img_0029" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0029" data-caption="Sunset" alt="Sunset" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0029')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/maldives/img_0030" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0030" data-caption="Hammock life" alt="Hammock" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0030')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/maldives/img_0031" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0031" data-caption="The beach" alt="Beach" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0031')" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/maldives/img_0034" class="story-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0034" data-caption="The lagoon" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <div class="image-row image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0128" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0128" data-caption="Giant chess" alt="Chess" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0128')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0129" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0129" data-caption="Island life" alt="Island life" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0129')" style="cursor:pointer">
 </div>
 <div class="image-row image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0062" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0062" data-caption="Island pathways" alt="Garden pathway" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0062')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0064" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0064" data-caption="Island pathways" alt="Garden pathway" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0064')" style="cursor:pointer">
 </div>
 </div>
 ...
 <div class="image-row image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0146" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0146" data-caption="The stage at night" alt="Stage" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0146')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0147" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0147" data-caption="Our setup" alt="Setup" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0147')" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/maldives/img_0100" class="story-image" data-caption="Performing by the water" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p>The reef sharks were everywhere. Swimming by the restaurant, circling near the beach.</p>
 <div class="image-row image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0092" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0092" data-caption="Please Do Not Feed The Fish" alt="Sign" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0092')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0861" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0861" data-caption="Reef shark" alt="Shark" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0861')" style="cursor:pointer">
 </div>
 </div>
 ...
 <div class="image-row image-row-3">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/maldives/img_0052" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0052" data-caption="New Year's Eve" alt="NYE" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0052')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/maldives/img_0054" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0054" data-caption="Fireworks through palms" alt="Fireworks" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0054')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/maldives/img_0056" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0056" data-caption="Midnight" alt="Midnight" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0056')" style="cursor:pointer">
 </div>
 </div>
 ...
 <div class="image-row image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0066" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0066" data-caption="The pool table" alt="Pool table" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0066')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0069-2" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0069-2" data-caption="Evening game" alt="Playing pool" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0069-2')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-3">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/maldives/img_0093" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0093" data-caption="Breakfast" alt="Breakfast" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0093')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/maldives/img_0094" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0094" data-caption="Japanese appetizers" alt="Japanese" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0094')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/maldives/img_0104" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0104" data-caption="Asahi and friends" alt="Beer" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0104')" style="cursor:pointer">
 </div>
 <div class="image-row image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0865" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0865" data-caption="Sushi spread" alt="Sushi" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0865')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/maldives/img_0143" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0143" data-caption="The bar" alt="Bar" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0143')" style="cursor:pointer">
 </div>
 </div>
 ...
 <div class="image-row image-row-3">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/maldives/img_0187" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0187" data-caption="The atolls from above" alt="Atoll" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0187')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/maldives/img_0190" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0190" data-caption="Overwater bungalows" alt="Bungalows" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0190')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/maldives/img_0880" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0880" data-caption="The marina" alt="Marina" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/maldives/img_0880')" style="cursor:pointer">
 </div>
 </div>
...
an original composition inspired by this place.
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/noumea/coastline_view.jpg" class="story-image" alt="Noumea coastline" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/noumea/number_one_beer.jpg" class="story-image" alt="Number One beer" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/noumea/pier_turquoise.jpg" class="story-image" alt="Wooden pier" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Noumea' : '+ More about Noumea'">+ More about Noumea</p>
 <div class="more-info-content">
 <p><strong>French Territory:</strong> New Caledonia is a French overseas territory in the South Pacific. Noumea feels like a slice of France transplanted to Melanesia.</p>
 <p><strong>Nickel Capital:</strong> New Caledonia has about 25% of the world's known nickel reserves. Mining has shaped the economy and landscape for over a century.</p>
 <p><strong>UNESCO Lagoon:</strong> The lagoon surrounding New Caledonia is a UNESCO World Heritage site - the largest in the world, with the most diverse concentration of reef structures.</p>
 <p><strong>Kanak Culture:</strong> The indigenous Kanak people have lived here for over 3,000 years. Their culture remains vibrant alongside the French colonial heritage.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1770163382/IMG_2049.jpg" class="story-image" data-caption="Looking back toward the new city." alt="Looking back toward the new city" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p>And to the right of me, down the hill.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1770084065/IMG_2074.jpg" class="story-image" data-caption="Down the hill toward the walled city." alt="Down the hill toward the walled city" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1770083976/IMG_2073.jpg" class="story-image" data-caption="Coffee and a guide to the city." alt="Coffee and a guide to the city" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1770149008/IMG_2113.jpg" class="story-image" data-caption="Walking toward the gates." alt="Walking toward the gates of Dubrovnik" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1770149006/IMG_2116.jpg" class="story-image" data-caption="At the gates." alt="At the gates of Dubrovnik" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/dubrovnik/gates_harbor_view" class="story-image" data-caption="Through the ancient iron bars, the harbor sparkles below." alt="View through the gates" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/dubrovnik/harbor_monastery" class="story-image" data-caption="The Dominican Monastery bell tower rises above the harbor." alt="Harbor and monastery" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/dubrovnik/streets_04" class="story-image" data-caption="The Stradun opens into the main square." alt="Dubrovnik main square" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/dubrovnik/parrots" class="story-image" data-caption="Colorful parrots on the Stradun." alt="Parrots on the street" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/dubrovnik/church_interior" class="story-image" data-caption="Inside the Jesuit Church of St. Ignatius." alt="Church interior" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/dubrovnik/kayaks_bokar" class="story-image" data-caption="Kayaks lined up beneath Bokar Fortress." alt="Kayaks at Bokar Fortress" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1770083064/Screen_Shot_2026-02-02_at_8.40.38_PM.jpg" class="story-image" data-caption="Ocean kayaking around the city walls." alt="Ocean kayaking in Dubrovnik" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/dubrovnik/crew_party" class="story-image" data-caption="Crew night out in Dubrovnik." alt="Crew party" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/dubrovnik/sunset_sailaway" class="story-image" data-caption="Sunset sailaway from Dubrovnik." alt="Sunset sailaway" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/nw-australia-indonesia/lombock" class="story-image" data-caption="Balinese dancers in traditional costume welcomed us ashore." alt="Balinese dancers" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/bali/img_0277" class="story-image" data-caption="A Balinese temple with traditional architecture and manicured grounds." alt="Balinese temple" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Temple grounds that have been sacred for centuries.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/bali/img_0267" class="story-image" data-caption="An ornate Garuda statue - the mythical bird that carries the gods." alt="Garuda statue" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/nw-australia-indonesia/img_0238" class="story-image" data-caption="Street scene with souvenir stands and the Indonesian flag." alt="Bali street" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The streets were a sensory overload - colors, sounds, smells.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/nw-australia-indonesia/img_0257" class="story-image" data-caption="Market stalls with clothing and souvenirs." alt="Market stalls" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Market stalls stretched on forever. The bargaining was half the fun.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/bali/img_0275" class="story-image" data-caption="Welcome at Poppies - the famous lane in Kuta." alt="Poppies Lane" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/nw-australia-indonesia/img_0244" class="story-image" data-caption="A plate of fresh tropical fruit - watermelon, pineapple, starfruit." alt="Tropical fruit" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Tropical fruit arranged like art. Half of these I'd never seen before.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/nw-australia-indonesia/img_0245" class="story-image" data-caption="Indonesian rice dish with chicken and vegetables." alt="Indonesian food" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The real thing - not cruise ship Indonesian, but street food Indonesian.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/nw-australia-indonesia/img_0179" class="story-image" data-caption="Lobster lunch with a cold beer." alt="Lobster lunch" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/bali/img_0273" class="story-image" data-caption="A colorfully painted jeep on the streets of Bali." alt="Painted jeep" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Even the vehicles were works of art.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/bali/img_0272" class="story-image" data-caption="Hard Rock Cafe Bali - the guitar sign against tropical trees." alt="Hard Rock Bali" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Hard Rock Bali. Because of course there's a Hard Rock.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/nw-australia-indonesia/rest2" class="story-image" data-caption="Thatched roof entrance through a tropical garden." alt="Garden path" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/bali/img_0265" class="story-image" data-caption="Sunset over the Indonesian islands from the ship." alt="Indonesian sunset" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Sailing away from Bali as the sun set behind the volcanic peaks.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/bali/img_0284" class="story-image" data-caption="Traditional sailing boats in Bali's harbor." alt="Bali harbor" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Bali' : '+ More about Bali'">+ More about Bali</p>
 <div class="more-info-content">
 <p><strong>Hindu Island:</strong> Bali is the only Hindu-majority island in Muslim-majority Indonesia. Over 90% of Balinese practice a unique form of Hinduism blended with local traditions.</p>
 <p><strong>Nyepi:</strong> The Balinese New Year is a day of complete silence. The entire island shuts down. No one goes outside. Even the airport closes for 24 hours.</p>
 <p><strong>Daily Offerings:</strong> Those small palm leaf baskets with flowers and rice you see everywhere are called canang sari. Balinese make fresh offerings every single day to maintain harmony with the spirits.</p>
 <p><strong>Sacred Monkeys:</strong> The monkey forests aren't just tourist attractions. They're considered sacred spaces where the barrier between the physical and spiritual worlds is thinner.</p>
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768532511/IMG_0240_yg0xap.jpg" class="story-image" alt="Sea day view" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768951510/Screenshot_20260120_142607_Facebook_z1yo15.jpg" class="story-image" alt="At sea" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768532337/DSC002971st_prbc0u.jpg" class="story-image" alt="At Komodo National Park" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768532354/DSC00301_czqyrm.jpg" class="story-image" alt="Komodo landscape" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768532360/DSC002982nd_rlitb4.jpg" class="story-image" alt="Komodo Island" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769822864/komodo_compar_resizee_h55pu7.jpg" class="story-image" alt="Komodo dry season" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline" style="margin-top: 0.5rem;"><strong>Dry Season (May-Oct)</strong><br>Brown savanna, African vibes</p>
 </div>
 <div style="text-align: center;">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769821345/here_is_what_komodo_looks_like_in_the_rainy_season_owwbxt.jpg" class="story-image" alt="Komodo rainy season" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/shiplife/ushuaia/img_6607" class="story-image" alt="Tierra del Fuego" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The dramatic approach to Ushuaia - snow-capped peaks and the Beagle Channel.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770190757/IMG_6608" class="story-image" alt="Tierra del Fuego" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770190755/IMG_6612" class="story-image" alt="Tierra del Fuego" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/ushuaia/img_6615" class="story-image" alt="Tierra del Fuego" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/ushuaia/img_6619" class="story-image" alt="Tierra del Fuego" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/shiplife/ushuaia/img_6621" class="story-image" alt="Tierra del Fuego" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/shiplife/ushuaia/img_6606" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/ushuaia/img_6601" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770762692/IMG_6600" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770762692/IMG_6598" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770762693/IMG_6597" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/shiplife/ushuaia/img_6588" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/ushuaia/img_6586" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770762704/IMG_6582" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770762705/IMG_6581" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770762705/IMG_6579" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/shiplife/ushuaia/20150224_131338" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/ushuaia/img_6577" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770762697/IMG_6587" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770762696/IMG_6594" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770762695/IMG_6595" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770838465/shiplife/ushuaia/cmnissrwkw5d8vtc6bmi" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770762535/IMG_6602" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770838462/shiplife/ushuaia/i7i6r7k6kltw8uthq7zt" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770838466/shiplife/ushuaia/lqky0523gozez72nam8m" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770762504/IMG_6667" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770762521/IMG_6684" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770762529/IMG_6692" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/ushuaia/c7xcneiwndvbqmewhsgh" class="story-image" alt="Ushuaia" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769824113/walking_to_portofino_jjhdgl.jpg" class="story-image" alt="Walking to Portofino" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The path hugs the coastline. Every turn reveals something new.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769823951/portofino_hike_vxjb0v.jpg" class="story-image" alt="Hiking to Portofino" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769824104/closer_to_portofino_zeglqn.jpg" class="story-image" alt="View approaching Portofino" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">Almost there. The villas and church tower come into view through the pines.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769824456/Screen_Shot_2026-01-30_at_8.54.52_PM_omqmyt.png" class="story-image" alt="Arrival at Portofino" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768951563/Screenshot_20260120_140713_Facebook_wjt37q.jpg" class="story-image" data-caption="The narrow alleys of Portofino lead down to the famous harbor." alt="Portofino alley to harbor" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <p>Our workflow goes like this: Derrick shows me photos from an external drive. I can see them. He tells me what he remembers. We try to find words that honor those memories. We go back and forth. He corrects me when I get the tone wrong. I suggest structure. He provides soul. Slowly, a panel takes shape.</p>
 <p>The crew in the water at Isle of Pines. The party that got out of hand in Hobart. The scooter quest for pasta in Patmos. The exact placement of a photo caption. The search for a sentence that feels true. These conversations have filled hundreds of hours.</p>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838012/shiplife/rome/girorp2kzs39ndiwhsab.jpg" class="story-image" data-caption="The port of Civitavecchia." alt="Civitavecchia port" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838010/shiplife/rome/l6fqmoutdg0tnj26sjgn.jpg" class="story-image" data-caption="The port town of Civitavecchia." alt="Civitavecchia port" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The port town of Civitavecchia. Rome is about 80km inland.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838028/shiplife/rome/pfwy9pa0hz92crmpnrxo.jpg" class="story-image" data-caption="Train ticket to Rome." alt="Train ticket" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">I bought my train ticket to the city.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838029/shiplife/rome/msz5gefit3ybqzbch4w5.jpg" class="story-image" data-caption="Train tracks at Civitavecchia." alt="Train tracks" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838021/shiplife/rome/pew93ifghhoqnuyqsieq.jpg" class="story-image" data-caption="View from the train to Rome." alt="View from train" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">On the train. Still had no idea if I was going in the right direction.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838011/shiplife/rome/zxkjwys2pjwmq0pyxp3y.jpg" class="story-image" data-caption="The Colosseum." alt="The Colosseum" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838017/shiplife/rome/e0ameitjiqqu9e0mxi43.jpg" class="story-image" data-caption="Rome, Italy" alt="Rome" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838018/shiplife/rome/kxyte3ynr7355ezc3lgq.jpg" class="story-image" data-caption="Rome, Italy" alt="Rome" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838014/shiplife/rome/qsrhsjw3lpcdnbr3yv7p.jpg" class="story-image" data-caption="Rome, Italy" alt="Rome" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838016/shiplife/rome/fdgqcjiqjmlnewfg2lar.jpg" class="story-image" data-caption="Rome, Italy" alt="Rome" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838015/shiplife/rome/ovpgv5wsd5mgvbijcxhj.jpg" class="story-image" data-caption="Rome, Italy" alt="Rome" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 </div>
 ...
 <div class="gallery-story-section">
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838008/shiplife/rome/fh9wnajmt3blqcq0q09f.jpg" class="story-image" data-caption="Rome, Italy" alt="Rome" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838003/shiplife/rome/vtdolegstghw3pmp9hnn.jpg" class="story-image" data-caption="Rome, Italy" alt="Rome" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838003/shiplife/rome/afsgrck9i4z3pqn6p6wb.jpg" class="story-image" data-caption="Rome, Italy" alt="Rome" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838002/shiplife/rome/ddlpxcctghpyhgpcoi96.jpg" class="story-image" data-caption="Rome, Italy" alt="Rome" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838001/shiplife/rome/gtuu19gmolzawnz26bkj.jpg" class="story-image" data-caption="Rome, Italy" alt="Rome" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1770838000/shiplife/rome/bijtthnfuufykoykynfw.jpg" class="story-image" data-caption="Rome, Italy" alt="Rome" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 </div>
 </details>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769037282/058_yjvfcg.jpg" class="story-image" data-caption="Pacific Jewel in dry dock, Singapore." alt="Pacific Jewel in dry dock" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769037276/102_ly7caf.jpg" class="story-image" data-caption="The Jewel getting her name - one of the last things they do before leaving dry dock." alt="Jewel getting its name" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">Pacific Jewel in dry dock. Workers everywhere. Scaffolding. Chaos. This was home now.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769455518/100_ik4c2a.jpg" class="story-image" data-caption="Workers biking past the Jewel on their lunch break." alt="Dry dock workers biking" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769455580/061_mtftgb.jpg" class="story-image" data-caption="The dry dock in full swing." alt="Dry dock" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">Lunch break. Workers biking past like this was just another day. For them it was.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769455594/057-2_fr8tmk.jpg" class="story-image" data-caption="Dry dock operations." alt="Dry dock" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769455599/056-2_eekdld.jpg" class="story-image" data-caption="The Jewel being transformed." alt="Dry dock transformation" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769462730/062_c5wqik.jpg" class="story-image" data-caption="Christmas decorations in dry dock." alt="Christmas in dry dock" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769031185/060_mhyxga.jpg" class="story-image" data-caption="The Orient Bar during dry dock. Under construction." alt="Orient Bar under construction" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,a_90/v1769037282/072-2_hxubqq.jpg" class="story-image" data-caption="The Singapore MRT. Our escape route." alt="Singapore MRT" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769037282/073_jozbht.jpg" class="story-image" data-caption="The MRT station." alt="Singapore MRT" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">The MRT. Our escape route to air conditioning and wifi.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769037276/012-2_m4xovl.jpg" class="story-image" data-caption="The electronics mall. My favorite spot in Singapore." alt="Electronics mall" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769454682/IMG_0302_fq3c0b.jpg" class="story-image" data-caption="Inside one of Singapore's massive malls." alt="Singapore mall interior" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769037276/081_rjivqx.jpg" class="story-image" data-caption="Marina Bay Sands under construction - we'd return in 2013 to see it finished." alt="Marina Bay Sands" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769037266/028-4_vgjdyu.jpg" class="story-image" data-caption="Musicians bonding in Singapore: Richard, Ashley, and Thomas." alt="Musicians bonding" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769030580/025_yqujzb.jpg" class="story-image" data-caption="The Orient Bar, finished." alt="The Orient Bar" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,a_90/v1769455293/039-3_z79ldk.jpg" class="story-image" data-caption="Getting ready to board on the red carpet. I've never been so nervous." alt="Red carpet boarding" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769030579/030_lzogz2.jpg" class="story-image" data-caption="Standing in front of the Pacific Jewel at Darling Harbour." alt="Derrick at Darling Harbour" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769454688/008-2_jyut47.jpg" class="story-image" data-caption="Pacific Jewel in Sydney Harbour." alt="Pacific Jewel in Sydney Harbour" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769031021/026-5_r4ehv3.jpg" class="story-image" data-caption="Sydney Harbour panorama." alt="Sydney Harbour" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769030579/035_lhmdeq.jpg" class="story-image" data-caption="The inaugural party setup. Pink Hummer limos." alt="Inaugural party setup" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769031099/046-2_csspcp.jpg" class="story-image" data-caption="The deck party at night." alt="Deck party" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">The setup. The deck party. Would it rain?</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769037257/043-3_qkjmjo.jpg" class="story-image" data-caption="Musos waiting for the sky to clear. Would it rain?" alt="Waiting for fireworks" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Musos waiting for the sky to clear.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769037256/016-5_pqce0o.jpg" class="story-image" data-caption="Famous Australian talent showed up for the party." alt="Australian celebrity" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769030580/060_dczkem.jpg" class="story-image" data-caption="Opera House at night as we sailed away." alt="Opera House at night" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Through the porthole. Then past us. Then gone.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769455266/056-4_zckas4.jpg" class="story-image" data-caption="Fireworks for the Jewel's inaugural voyage." alt="Inaugural fireworks" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <div class="image-row-2">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769030579/045_ngolea.jpg" class="story-image" data-caption="Sydney Showboat escorting us out." alt="Sydney Showboat" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769037243/004-6_gfk1p1.jpg" class="story-image" data-caption="Me at the piano in the Orient Bar." alt="Derrick at the piano" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769037243/005-7_muz86f.jpg" class="story-image" data-caption="My first night in the Orient." alt="First night Orient Bar" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769037243/003-7_vqkbd8.jpg" class="story-image" data-caption="Me with guests in the Orient Bar." alt="With guests" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">The room came alive. Guests everywhere.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769037257/002-7_bmhskm.jpg" class="story-image" data-caption="More guests in the Orient." alt="More guests" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769037256/001-5_exb3r6.jpg" class="story-image" data-caption="The bar full of life." alt="Orient Bar guests" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/shiplife/fiordland/img_4169" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Entering Milford Sound - sheer cliffs rising straight from the water.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/fiordland/img_4185" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/fiordland/img_4188" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/fiordland/img_4191" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/fiordland/img_4195" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/shiplife/fiordland/img_4206" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/fiordland/img_4207" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/fiordland/img_4211" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/shiplife/fiordland/img_4217" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/fiordland/img_4231" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/fiordland/img_4237" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/fiordland/img_4241" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/fiordland/img_4244" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/shiplife/fiordland/img_4263" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The scale is impossible to capture - cliffs rising 1,200 meters straight up from the water.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/fiordland/img_4282" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/fiordland/img_0802" class="story-image" alt="Fiordland" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/fiordland/img_4288" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/fiordland/img_4290" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/shiplife/fiordland/img_4292" class="story-image" alt="Milford Sound" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Milford Sound' : '+ More about Milford Sound'">+ More about Milford Sound</p>
 <div class="more-info-content">
 <p><strong>The Eighth Wonder:</strong> Rudyard Kipling called Milford Sound the eighth wonder of the world after visiting in 1891. The description stuck.</p>
 <p><strong>Not a Sound:</strong> Despite its name, Milford Sound is actually a fjord. Sounds are formed by rivers, fjords by glaciers. The Maori name is Piopiotahi.</p>
 <p><strong>Wettest Place:</strong> Milford receives about 7 meters of rain annually, making it one of the wettest inhabited places on Earth. The rain creates thousands of temporary waterfalls.</p>
 <p><strong>Freshwater Layer:</strong> So much rain falls that a layer of fresh water sits on top of the salt water, stained dark by tannins. This creates unusual conditions for marine life.</p>
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1769817323/IMG_0843_bhszx1.jpg" class="story-image" alt="Ancient forest graveyard" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1769817327/IMG_0842_fj656g.jpg" class="story-image" alt="Stephen King graveyard vibes" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-11_hzettl.jpg" class="story-image" alt="Akaroa harbor view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The harbor stretched out like a secret waiting to be discovered.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-12_p6l8ha.jpg" class="story-image" alt="Akaroa landscape" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-13_vxtdlc.jpg" class="story-image" alt="Akaroa scenery" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-01_yakkpj.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-02_rcfy42.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-03_mazn3s.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-04_ph0r74.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-05_v26ryz.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-06_t4ay3f.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-07_wskpez.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-08_i7tlb9.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-10_jbnkjf.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-16_e7rro9.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-17_vncbyi.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-18_nqkyw9.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-19_ywgloa.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-20_icr5jf.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-21_yrnnkf.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-22_ya66e6.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-23_fpnuh0.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-24_zqrbua.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-25_gbv86c.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-26_bxui9c.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-27_dcjsfn.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-28_sqmebs.jpg" class="story-image" alt="Akaroa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-29_t7whzs.jpg" class="story-image" alt="Akaroa panorama" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/akaroa-30_yrmpiw.jpg" class="story-image" alt="Akaroa lighthouse panorama" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769817323/IMG_0843_bhszx1.jpg" class="story-image" alt="Akaroa graveyard" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1769817327/IMG_0842_fj656g.jpg" class="story-image" alt="Akaroa forest graveyard" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 </details>
 </div>
...
an original composition inspired by this place.
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770836788/shiplife/dunedin/x7ibk9epxhahoj1t2n7g.jpg" class="story-image" data-caption="The dramatic cliffs of the Otago Peninsula." alt="Otago Peninsula cliffs" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770836785/shiplife/dunedin/nrh6ouaaqu23xvzruaao.jpg" class="story-image" data-caption="Volcanic cliffs rising from the sea." alt="Peninsula cliffs with boat" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770836773/shiplife/dunedin/xtvh4ezfveaxonxm1is5.jpg" class="story-image" data-caption="Victorian Dunedin with the harbor beyond." alt="Dunedin town view" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770836757/shiplife/dunedin/tbqhft210vpo8s7uizav.jpg" class="story-image" data-caption="The town under misty Otago skies." alt="Dunedin with church spire" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770836769/shiplife/dunedin/fmmf2a13jra1ozt6fm3b.jpg" class="story-image" data-caption="The Gothic stone church of Port Chalmers." alt="Gothic church" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770836768/shiplife/dunedin/tflscifiyxxzerg6bbk3.jpg" class="story-image" data-caption="The cruise terminal at Port Chalmers." alt="Cruise port with tugboat" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770836782/shiplife/dunedin/i6kklt76xhh05dafr7qh.jpg" class="story-image" data-caption="The working port with shipping containers." alt="Container port" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770836783/shiplife/dunedin/xsco0vd0kgzyvp45gj6t.jpg" class="story-image" data-caption="Misty hills above the harbor." alt="Harbor with hills" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">Port Chalmers is a working harbor. Shipping containers stack up beside the cruise berths.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770836769/shiplife/dunedin/euakzrsgxmxao5jog87d.jpg" class="story-image" data-caption="A Princess ship in port - we weren't the only ones visiting." alt="Princess cruise ship" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770836784/shiplife/dunedin/fi3a3weze0bhyp684pgl.jpg" class="story-image" data-caption="The formal gardens with their sculptural centerpiece." alt="Dunedin Botanic Garden" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770838433/shiplife/tonga/aielbng94fsgzye6bbdv.jpg" class="story-image" alt="Tonga" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770838420/shiplife/tonga/cbzlnct4qvducquqveql.jpg" class="story-image" alt="Tonga" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770838432/shiplife/tonga/cvrqbhs9l5d7zbzntjdg.jpg" class="story-image" alt="Tonga" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770838422/shiplife/tonga/kl9ouncqasywt6sus1pm.jpg" class="story-image" alt="Tonga" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770838434/shiplife/tonga/nhbayjavdf3xnbfu9q9d.jpg" class="story-image" alt="Tonga" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770838423/shiplife/tonga/nnly70dtjigyrgor8ezl.jpg" class="story-image" alt="Tonga" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770838431/shiplife/tonga/nwzmh0zgpkn1vcfsxwbg.jpg" class="story-image" alt="Tonga" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770838427/shiplife/tonga/s8yoso8jecurtiraciry.jpg" class="story-image" alt="Tonga" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770838430/shiplife/tonga/scnkke4rgh896lkith62.jpg" class="story-image" alt="Tonga" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770838428/shiplife/tonga/vn2oy9aff4ohai3ezspl.jpg" class="story-image" alt="World signpost" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770838426/shiplife/tonga/vu1ebmhax6tsdxacngxy.jpg" class="story-image" alt="Tonga" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770838429/shiplife/tonga/bbw7mkjkjwg6vnfsr8rs.jpg" class="story-image" alt="Polynesian show" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770838424/shiplife/tonga/cabzj35msernktmcz0te.jpg" class="story-image" alt="Polynesian show" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770838421/shiplife/tonga/g971pobihvgf2wnnhikq.jpg" class="story-image" alt="Local cuisine" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770838425/shiplife/tonga/y9fef2mveqsktdflb1au.jpg" class="story-image" alt="Tonga" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Tonga' : '+ More about Tonga'">+ More about Tonga</p>
 <div class="more-info-content">
 <p><strong>Never Colonized:</strong> Tonga is the only Pacific nation never formally colonized by a European power. It has been ruled by the same royal family since 1845.</p>
 <p><strong>First to See the Sun:</strong> Tonga spans the International Date Line. The easternmost islands are among the first places on Earth to see each new day.</p>
 <p><strong>Whale Watching:</strong> Humpback whales migrate to Tonga's warm waters between July and October to breed and give birth. Swimming with whales is a major draw.</p>
 <p><strong>Flying Foxes:</strong> Fruit bats are sacred in Tonga and can only be hunted by royalty. Colonies of them hang from trees throughout the islands.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770764142/off_the_main_island_bora_bora_-_Copy.jpg" class="story-image" alt="Mount Otemanu from lagoon" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770764108/098.jpg" class="story-image" alt="Jetskis on private island" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Jetskis on the private island beach. Shore leave at its finest.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770764118/065.jpg" class="story-image" alt="Small boat on calm lagoon" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770764114/054.jpg" class="story-image" alt="Tugboat with cruise ship" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770764133/097.jpg" class="story-image" alt="Cruise ship from local boat" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770764107/me_and_mark.jpg" class="story-image" alt="With Mark on the beach" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Ran into our production guy Mark coming back from jetskiing.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770764119/079.jpg" class="story-image" alt="Black sand beach" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770764123/080.jpg" class="story-image" alt="Black sand beach with jungle" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770764114/063.jpg" class="story-image" alt="Venus Point lighthouse" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Venus Point lighthouse - where Captain Cook observed the transit of Venus in 1769.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770764128/100.jpg" class="story-image" alt="Mountain road" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770764117/062.jpg" class="story-image" alt="Tahiti town" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">Dramatic mountain roads and the town below.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770764111/046.jpg" class="story-image" alt="Resort pool" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770764127/tahiti_waterfall.jpg" class="story-image" alt="Tahiti waterfall" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The waterfall at the end of the hike - worth every step.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770764109/038.jpg" class="story-image" alt="Swimming hole" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The swimming hole - cool water after a hot jungle trek.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_auto,f_auto/v1770764145/grapefruit_and_apple.jpg" class="story-image" alt="Fresh fruit" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Fresh fruit on woven palm leaves - the taste of the islands.</p>
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Bora Bora' : '+ More about Bora Bora'">+ More about Bora Bora</p>
 <div class="more-info-content">
 <p><strong>Pearl of the Pacific:</strong> Bora Bora's nickname comes from its stunning lagoon. The water ranges from pale turquoise to deep sapphire depending on depth and light.</p>
 <p><strong>Volcanic Origins:</strong> Mount Otemanu is the remnant of an extinct volcano. The island formed millions of years ago and has been slowly sinking ever since, leaving the lagoon behind.</p>
 <p><strong>Overwater Bungalows:</strong> The overwater bungalow was invented in French Polynesia in 1967. Three American hotel developers created the concept specifically for Tahiti.</p>
 <p><strong>Captain Cook:</strong> In 1769, Captain James Cook observed the transit of Venus from nearby Tahiti. Venus Point lighthouse marks the exact spot of his observations.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/port-vila/iririki_island.jpg" class="story-image" alt="Iririki Island" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/port-vila/sailing_boat_harbor.jpg" class="story-image" alt="Traditional sailing boat" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/port-vila/catamaran_harbor.jpg" class="story-image" alt="Catamaran at anchor" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/port-vila/thatched_beach_bar.jpg" class="story-image" alt="Beach bar" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Thatched roof, cold drinks, white sand - the essentials.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/port-vila/beach_bar_atvs.jpg" class="story-image" alt="Beach with ATVs" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Shore excursion staging area.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/port-vila/coral_beach_loungers.jpg" class="story-image" alt="Coral beach" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768966739/IMG_0357_uylflq.jpg" class="story-image" alt="Hull damage" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/lifou/tender_approach.jpg" class="story-image" alt="Approaching Lifou by tender" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/lifou/turquoise_bay_hut.jpg" class="story-image" alt="Turquoise bay" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <span class="section-tag-panel">The Beach</span>
 <h3 class="section-title-panel">Island Time</h3>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/lifou/thatched_hut_banyan.jpg" class="story-image" alt="Thatched hut under banyan" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">A local under his thatched shelter, banyan roots behind him.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/lifou/beach_scene_1.jpg" class="story-image" alt="Beach scene" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/lifou/beach_scene_2.jpg" class="story-image" alt="Beach scene" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">The beaches of Lifou. No resorts, no crowds. Just sand and water.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/lifou/beach_scene_4.jpg" class="story-image" alt="Beach scene" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768963793/New_Caldonia_church_t4pfw4.jpg" class="story-image" data-caption="The church on Lifou - I visited this spot every time we called here." alt="Lifou church" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
...
an original composition inspired by this place.
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3069" class="story-image" data-caption="The quiet harbor of Adamas in the early morning." alt="Milos harbor" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3071" class="story-image" data-caption="Flower-lined lanes through the village." alt="Village lane" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3074" class="story-image" data-caption="The volcanic interior of Milos stretches to the sea." alt="Volcanic landscape" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3123" class="story-image" data-caption="Dusty roads leading toward the sea." alt="Island road" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The roads were dusty and mostly empty. Perfect scooter territory.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3086" class="story-image" data-caption="Rural Milos - hay bales and volcanic hills." alt="Rural landscape" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3115" class="story-image" data-caption="Red and white volcanic rock formations." alt="Volcanic colors" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Red and white volcanic layers - the island's fiery origins on full display.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3118" class="story-image" data-caption="The volcanic palette of Milos." alt="Rock formations" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3087" class="story-image" data-caption="First glimpse of the cove - red volcanic cliffs and turquoise water." alt="Cove view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The first glimpse stopped me cold. Red cliffs, turquoise water, white buildings below.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3088" class="story-image" data-caption="The road descending to the fishing village." alt="Road to cove" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3098" class="story-image" data-caption="The cove - possibly the most beautiful place I've ever been." alt="The cove" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The cove. Swimmers in crystal water. A place that felt like it shouldn't exist.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3089" class="story-image" data-caption="Crystal clear water between volcanic rocks." alt="Clear water" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The water was impossibly clear - turquoise fading to deep blue between the rocks.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3090" class="story-image" data-caption="Fishing boats in the colorful harbor." alt="Harbor boats" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3104" class="story-image" data-caption="Greek Orthodox chapel overlooking the bay." alt="Chapel with sea" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The chapel watched over the bay - white walls, blue trim, volcanic cliffs, turquoise sea.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3103" class="story-image" data-caption="Classic Cycladic architecture against the volcanic hills." alt="White chapel" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3094" class="story-image" data-caption="Ancient ruins framing the Aegean." alt="Stone ruins" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">An ancient doorway framing the sea - still standing after millennia.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/milos/img_3113" class="story-image" data-caption="The volcanic coastline stretches into the distance." alt="Coastline" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The volcanic coastline stretched on forever. And somewhere, my ship was waiting.</p>
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Milos' : '+ More about Milos'">+ More about Milos</p>
 <div class="more-info-content">
 <p><strong>Venus de Milo:</strong> The famous armless statue in the Louvre was discovered here in 1820 by a farmer. It was carved around 100 BC and is considered one of the greatest sculptures ever made.</p>
 <p><strong>Volcanic Island:</strong> Milos is volcanic, which explains its extraordinary geology. The island has over 70 beaches, each with different colored sand and rock.</p>
 <p><strong>Mining History:</strong> Milos has been mined for obsidian since prehistoric times. Today it exports bentonite and perlite, making it one of the most industrialized Cycladic islands.</p>
 <p><strong>Hidden Gem:</strong> While Santorini and Mykonos overflow with tourists, Milos remains relatively undiscovered. Its lunar landscapes and sea caves reward those who venture here.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/santorini/dhdiad1fxklbqpblt03u.jpg" class="story-image" data-caption="Sailing into Santorini's caldera - ships gather beneath the volcanic cliffs." alt="Ships in Santorini caldera" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/santorini/img_3511" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/santorini/img_3511" data-caption="Fira cascading down the volcanic cliffs" alt="Fira town view" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/santorini/img_3511')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/santorini/img_3466" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/santorini/img_3466" data-caption="The caldera with Nea Kameni beyond" alt="Caldera view" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/santorini/img_3466')" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/santorini/img_3470" class="story-image" data-caption="White domes cascading down to the caldera." alt="White domes and caldera" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/santorini/w4dpnl8gzx2ibhllyd6z.jpg" class="story-image" data-caption="The old port below the cliffs - traditional boats still ferry passengers." alt="Old port with boat" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/santorini/img_3525" class="story-image" data-caption="The famous Santorini donkeys - still carrying passengers up 588 steps." alt="Santorini donkeys" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/santorini/fak4vfvkzksog9onloyy.jpg" class="story-image" data-caption="Houses carved directly into the volcanic rock." alt="Cliff houses" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/santorini/gcxwoaxhvwtwhzfgzmjg.jpg" class="story-image" data-caption="A quiet courtyard - the Greek arch framing traditional architecture." alt="Greek courtyard" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">A quiet courtyard off the main path. The Greek arch. The terracotta pots. The whitewash.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/santorini/img_3496" class="story-image" data-caption="The Catholic Cathedral's pink tower beside a white Orthodox dome." alt="Church towers" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/santorini/vxllo2hmxhpjwybu9tmm.jpg" class="story-image" data-caption="Hotel Atlantis - classic Cycladic architecture in brilliant white." alt="Hotel Atlantis" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/santorini/lykhhj6krfmt7jzg9bwx.jpg" class="story-image" data-caption="Red geraniums against the white - color everywhere." alt="Red flowers with white building" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The red geraniums against the white. Color punctuating every corner.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/santorini/yuytj8wd6vznwvuhrtkr.jpg" class="story-image" data-caption="Restaurants perched on the caldera rim - dining with the view." alt="Caldera restaurants" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Santorini' : '+ More about Santorini'">+ More about Santorini</p>
 <div class="more-info-content">
 <p><strong>The Eruption:</strong> Around 1600 BC, one of history's largest volcanic eruptions destroyed the Minoan settlement here and may have inspired the legend of Atlantis.</p>
 <p><strong>The Caldera:</strong> The crescent-shaped island is actually the rim of a massive volcanic crater. The sea in the middle is 400 meters deep.</p>
 <p><strong>Wine Region:</strong> Santorini's volcanic soil produces distinctive wines. The Assyrtiko grape grows in basket shapes to protect it from the constant winds.</p>
 <p><strong>Sunset Capital:</strong> Oia's sunset draws thousands of visitors daily. People applaud as the sun drops below the horizon - a tradition that started in the 1970s.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/symi/img_5786" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5786" data-caption="The colorful harbor" alt="Harbor view" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5786')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/symi/img_5787" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5787" data-caption="Neoclassical facades" alt="Facades" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5787')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/symi/img_5791" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5791" data-caption="Reflections in the harbor" alt="Reflections" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5791')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/symi/img_5792" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5792" data-caption="Pastel houses" alt="Pastel houses" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5792')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/symi/img_5793" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5793" data-caption="Symi's waterfront" alt="Waterfront" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5793')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-5">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/symi/img_5796" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5796" data-caption="Views from above" alt="Upper town view" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5796')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/symi/img_5797" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5797" data-caption="Climbing to Chorio" alt="Chorio" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5797')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/symi/img_5799" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5799" data-caption="Island details" alt="Details" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5799')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/symi/img_5800" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5800" data-caption="Aegean blues" alt="Aegean" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5800')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/symi/img_5801" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5801" data-caption="Symi memories" alt="Symi" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/symi/img_5801')" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/patmos/img_20130911_121433" class="story-image" data-caption="The view from above Skala" alt="Skala port view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_auto,f_auto/shiplife/patmos/pano_20130911_131604" class="story-image" data-caption="The view from my scooter" alt="Scooter POV" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row image-row-3">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/patmos/img_20130911_122138" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_20130911_122138" data-caption="Stopped to take in the view" alt="Panoramic view" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_20130911_122138')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/patmos/img_20130911_122115" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_20130911_122115" data-caption="The bay spread out below" alt="Bay view" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_20130911_122115')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/patmos/img_3421" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_3421" data-caption="The fishing harbor" alt="Fishing harbor" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_3421')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-3">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/patmos/img_20130913_125543" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_20130913_125543" data-caption="Bell tower against blue sky" alt="Church bell tower" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_20130913_125543')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/patmos/img_3416" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_3416" data-caption="The bells of Patmos" alt="Church bells" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_3416')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/patmos/img_3429" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_3429" data-caption="The monastery on the hill" alt="Monastery view" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_3429')" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/patmos/img_3415" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_3415" data-caption="The main square" alt="Town square" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_3415')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/patmos/img_3418" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_3418" data-caption="Stone arches" alt="Arched colonnade" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_3418')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/patmos/img_3420" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_3420" data-caption="Vine tunnel" alt="Vine pathway" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_3420')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/patmos/img_3423" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_3423" data-caption="Another shaded lane" alt="Vine archway" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/patmos/img_3423')" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">The Greeks mastered shade architecture centuries ago.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/patmos/img_20130913_141319" class="story-image" data-caption="Local residents" alt="Geese in square" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/patmos/img_3431" class="story-image" data-caption="The perfect pasta" alt="Fresh pasta" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/piran/img_1778" alt="Piran waterfront" data-caption="Piran's waterfront - Venetian architecture meets the Adriatic." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/piran/img_1770" alt="Piran streets" data-caption="The narrow streets of Piran's old town." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/piran/img_1772" alt="Tartini Square" data-caption="Tartini Square - the elegant heart of Piran." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/piran/img_1776" alt="View from St. George" data-caption="Views over Piran from the Church of St. George." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768951532/Screenshot_20260120_141730_Facebook_kjfnuv.jpg" class="story-image" data-caption="The Lipizzan horses performing classical dressage at Lipica." alt="Lipizzan horse performance at Lipica" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768951532/Screenshot_20260120_141721_Facebook_zyavdi.jpg" class="story-image" data-caption="Lipica Stud Farm - home of the Lipizzan breed since 1580." alt="Lipica Stud Farm horse show" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/kotor/IMG_1460" class="story-image" data-caption="Threading through the Bay of Kotor from the ship's bow." alt="Ship approaching Kotor" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The view from the bow as we thread through Europe's southernmost fjord.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/kotor/IMG_1427" class="story-image" data-caption="Morning mist on the Bay of Kotor." alt="Misty bay" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/kotor/IMG_2248" class="story-image" data-caption="Seabourn Odyssey docked in Kotor." alt="Seabourn at dock" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The Odyssey docked at Kotor's waterfront - mountains pressing in from all sides.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/kotor/IMG_2285" class="story-image" data-caption="The emerald moat and fortress walls." alt="Kotor moat" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/kotor/IMG_2274" class="story-image" data-caption="A hidden square with palm tree and water pump." alt="Kotor square" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Turn a corner and find a quiet square with a palm tree and an ancient water pump.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/kotor/IMG_2262" class="story-image" data-caption="Courtyard with flowers in Kotor's old town." alt="Kotor courtyard" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Every courtyard is someone's garden. Flowers spill out of every window.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/kotor/IMG_2271" class="story-image" data-caption="Looking through a window frame to a house beyond." alt="Window frame view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/kotor/IMG_1652" class="story-image" data-caption="Church bell tower with the ship in the bay below." alt="Church tower and ship" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The Church of Our Lady of Remedy marks the halfway point. The ship already looks small.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/kotor/IMG_1687" class="story-image" data-caption="View through an arrow slit to the harbor below." alt="Arrow slit view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Through an arrow slit - the same view defenders had centuries ago.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/kotor/IMG_1629" class="story-image" data-caption="Aerial view of Kotor's old town and harbor." alt="Kotor from above" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">From near the top - orange rooftops, church domes, and ships in the bay.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/kotor/IMG_1722" class="story-image" data-caption="Victory at the top of Kotor's fortress." alt="At the summit" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/kotor/IMG_2622" class="story-image" data-caption="Sunset departure through the Bay of Kotor." alt="Sunset departure" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The view forward as we sail out - mountains silhouetted, clouds catching fire.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/kotor/IMG_2626" class="story-image" data-caption="Golden hour on the Bay of Kotor." alt="Golden hour bay" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/v1771800414/shiplife/syracuse/royal-clipper-bow.jpg" class="story-image" data-caption="The Royal Clipper's elegant bow." alt="Royal Clipper bow" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The Royal Clipper at anchor - her golden lettering catching the morning light.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771800415/shiplife/syracuse/seabourn-from-papyrus-garden.jpg" class="story-image" data-caption="Seabourn ship from papyrus garden." alt="Cruise ship in harbor" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771800416/shiplife/syracuse/sailing-boats-harbor.jpg" class="story-image" data-caption="Classic sailing boats." alt="Syracuse harbor" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/v1771800419/shiplife/syracuse/temple-apollo-columns.jpg" class="story-image" data-caption="Ancient columns still standing." alt="Temple of Apollo columns" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/v1771800421/shiplife/syracuse/temple-apollo-palm-trees.jpg" class="story-image" data-caption="Temple ruins amid palm trees." alt="Temple of Apollo" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/v1771800447/shiplife/syracuse/inda-theater-festival.jpg" class="story-image" data-caption="Greek theater festival poster." alt="INDA Theater Festival" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/v1771800431/shiplife/syracuse/fountain-diana-full.jpg" class="story-image" data-caption="The Fountain of Diana." alt="Fountain of Diana" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The Fountain of Artemis (Diana) - goddess of the hunt presiding over Ortygia's main square.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771800435/shiplife/syracuse/fountain-diana-closeup.jpg" class="story-image" data-caption="Diana close-up." alt="Diana statue" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771800436/shiplife/syracuse/ortigia-street-scene.jpg" class="story-image" data-caption="Ortygia streets." alt="Ortygia street" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/v1771800424/shiplife/syracuse/cathedral-facade.jpg" class="story-image" data-caption="The Cathedral facade." alt="Syracuse Cathedral" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771800425/shiplife/syracuse/cathedral-st-paul-statue.jpg" class="story-image" data-caption="St. Paul statue." alt="Cathedral statue" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771800426/shiplife/syracuse/santa-lucia-alla-badia.jpg" class="story-image" data-caption="Santa Lucia alla Badia." alt="Church facade" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771800438/shiplife/syracuse/palazzo-ornate-balconies.jpg" class="story-image" data-caption="Ornate Sicilian balconies." alt="Palazzo balconies" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771800440/shiplife/syracuse/locals-on-balconies.jpg" class="story-image" data-caption="Daily life in Ortygia." alt="Locals on balconies" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771800443/shiplife/syracuse/arethusa-spring-ducks.jpg" class="story-image" data-caption="Ducks at Arethusa Spring." alt="Arethusa Spring" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771800444/shiplife/syracuse/garden-iron-fence.jpg" class="story-image" data-caption="Papyrus garden." alt="Syracuse garden" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771800445/shiplife/syracuse/il-chioschetto-kiosk.jpg" class="story-image" data-caption="Il Chioschetto - refreshments." alt="Street kiosk" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771800418/shiplife/syracuse/harbor-fishing-boats.jpg" class="story-image" data-caption="Harbor life." alt="Fishing boats" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1767735863/IMG_1155_qtda7b.jpg" class="story-image" alt="Malta Grand Harbour" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1768951523/Screenshot_20260120_141946_Facebook_hakkap.jpg" class="story-image" alt="Malta view" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/gozo/20150606_103703" class="story-image" data-caption="The Citadel of Victoria, Gozo." alt="Gozo Citadel" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The Citadel panorama - fortified hilltop town watching over the island.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/gozo/20150606_103607" class="story-image" data-caption="Gozo architecture." alt="Gozo town" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Honey-colored limestone - the signature of Maltese architecture.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/gozo/20150606_104947" class="story-image" data-caption="Village street." alt="Village" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Village streets where time moves slower than on the mainland.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/gozo/20150606_105651" class="story-image" data-caption="Gozo scene." alt="Gozo" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The quieter pace of island life.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/gozo/20150606_110704" class="story-image" data-caption="Gozo view." alt="Gozo view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/gozo/20150606_1148390" class="story-image" data-caption="Church interior." alt="Church" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Stepping inside is like entering another world.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/gozo/20150606_115312" class="story-image" data-caption="Baroque altar and baldachin." alt="Altar" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The baldachin rises toward the painted dome - gold and marble and centuries of devotion.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/gozo/20150606_115325" class="story-image" data-caption="Church nave." alt="Church interior" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Every surface decorated, every detail considered.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/gozo/20150606_115822" class="story-image" data-caption="Ornate interior." alt="Church detail" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The checkered floor, the golden altar - baroque at its finest.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/gozo/20150607_133045" class="story-image" data-caption="Final church view." alt="Church" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
...
an original composition inspired by this place.
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/south-georgia-fjords/img_6725" class="story-image" data-caption="Sailing into the South Georgia fjords at dawn." alt="South Georgia fjords" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-georgia-fjords/img_6728" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6728" data-caption="Port side - glaciers tumbling down" alt="Port side" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6728')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-georgia-fjords/img_6731" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6731" data-caption="Starboard side - sheer mountain faces" alt="Starboard side" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6731')" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/south-georgia-fjords/img_6738" class="story-image" data-caption="The scale is impossible to comprehend." alt="Glacier scale" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-georgia-fjords/img_6744" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6744" data-caption="Leaving the fjords" alt="Leaving" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6744')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-georgia-fjords/img_6746" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6746" data-caption="Ice and rock" alt="Ice and rock" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6746')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-georgia-fjords/img_6750" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6750" data-caption="The passage widens" alt="Passage" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6750')" style="cursor:pointer">
 </div>
 <div class="image-row">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-georgia-fjords/img_6753" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6753" data-caption="Last glimpses" alt="Last glimpses" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6753')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-georgia-fjords/img_6760" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6760" data-caption="Heading toward Grytviken" alt="Toward Grytviken" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6760')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-georgia-fjords/img_6762" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6762" data-caption="The open water ahead" alt="Open water" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-georgia-fjords/img_6762')" style="cursor:pointer">
 </div>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768799519/IMG_6763_sxyz76.jpg" class="story-image" data-caption="Approaching South Georgia by zodiac - the Seabourn Quest anchored in the bay." alt="Seabourn Quest at South Georgia" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768798857/IMG_6834_fx0gdi.jpg" class="story-image" data-caption="The whale catcher Petrel, rusting where she was abandoned. Elephant seals now lounge on the beach." alt="Petrel whale catcher with elephant seals" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768799893/IMG_6827_sichau.jpg" class="story-image" data-caption="Mountains of anchor chain and a rotting boat hull - remnants of the whaling industry." alt="Anchor chains and wrecked boat" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768799322/IMG_6818_qwfqd8.jpg" class="story-image" data-caption="The whalers' church, framed by rusted industrial buildings." alt="Church behind rust" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768800003/IMG_6822_bz1res.jpg" class="story-image" data-caption="Interpretive sign: The Petrel and Workshops at Grytviken." alt="Infographic: Petrel and Workshops" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768799273/IMG_6824_icgv5s.jpg" class="story-image" data-caption="Interpretive sign: The Meal Plant where whale carcasses were processed." alt="Infographic: Meal Plant" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768799381/IMG_6796_dvoe4m.jpg" class="story-image" data-caption="A king penguin and fur seal in front of the abandoned whaling station." alt="King penguin and seal with ruins" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768799349/IMG_6805_mzyioi.jpg" class="story-image" data-caption="An Antarctic fur seal, completely at ease." alt="Fur seal portrait" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768799182/IMG_6830_copy_s3qmyz.jpg" class="story-image" data-caption="King penguin near the old pier, with an elephant seal resting behind." alt="King penguin with pier" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">Fur seals and king penguins have made Grytviken their home.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768799215/IMG_6825_copy_llb0iz.jpg" class="story-image" data-caption="Baby elephant seal. Those eyes." alt="Baby elephant seal" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768799453/IMG_6776_iwumrm.jpg" class="story-image" data-caption="Elephant seal enjoying a mud bath." alt="Elephant seal in mud" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768799428/IMG_6779_ustje1.jpg" class="story-image" data-caption="A young fur seal in the tussock grass, looking for its mother." alt="Baby seal in grass" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768799406/IMG_6787_uceutk.jpg" class="story-image" data-caption="Standing at Shackleton's grave. I stumbled upon it by accident." alt="At Shackleton's grave" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768799478/IMG_6773_qijzm5.jpg" class="story-image" data-caption="Our excursion group exploring the island." alt="Excursion group" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6697" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6697" data-caption="Approaching the channel" alt="Approach" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6697')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6698" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6698" data-caption="We're going in" alt="Entering" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6698')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6699" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6699" data-caption="Ice cliffs rising" alt="Ice cliffs" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6699')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6702" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6702" data-caption="Into Kodak Gap" alt="Kodak Gap" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6702')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6703" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6703" data-caption="Towering walls of ice" alt="Ice walls" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6703')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6704" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6704" data-caption="The channel narrows" alt="Narrow passage" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6704')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-6">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6706" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6706" data-caption="Mirror-still waters" alt="Still water" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6706')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6707" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6707" data-caption="Reflections" alt="Reflections" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6707')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6708" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6708" data-caption="Ice and sky" alt="Ice and sky" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6708')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6709" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6709" data-caption="Frozen silence" alt="Silence" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6709')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6710" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6710" data-caption="The passage continues" alt="Passage" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6710')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6711" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6711" data-caption="Antarctica's cathedral" alt="Cathedral" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6711')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-5">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6712" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6712" data-caption="The iconic view" alt="Iconic" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6712')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6713" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6713" data-caption="Emerging from the channel" alt="Emerging" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6713')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6714" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6714" data-caption="Looking back" alt="Looking back" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6714')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6715" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6715" data-caption="The other side" alt="Other side" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6715')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/lemaire/img_6716" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6716" data-caption="We made it through" alt="Through" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/lemaire/img_6716')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-4">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/20150217_092200" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_092200" data-caption="4am - getting ready for excursions" alt="Morning prep" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_092200')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/20150217_095324" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_095324" data-caption="Early morning Antarctic light" alt="Morning light" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_095324')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/img_6490" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6490" data-caption="Zodiac station setup" alt="Zodiac prep" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6490')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/img_6534" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6534" data-caption="Ready for guests" alt="Morning prep" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6534')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-6">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/img_6481" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6481" data-caption="Pre-dawn silence" alt="Pre-dawn" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6481')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/img_6487" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6487" data-caption="The frozen world" alt="Frozen landscape" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6487')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/img_6485" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6485" data-caption="Antarctic stillness" alt="Stillness" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6485')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/img_6467" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6467" data-caption="Ice in shadow" alt="Ice shadow" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6467')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/img_6459" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6459" data-caption="Waiting for sunrise" alt="Pre-sunrise" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6459')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/img_6451" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6451" data-caption="The quiet before" alt="Quiet morning" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6451')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-3">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/img_6443" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6443" data-caption="First penguin sighting" alt="Penguins" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6443')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/img_6447" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6447" data-caption="The colony comes alive" alt="Penguin colony" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6447')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/img_6446" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6446" data-caption="Unbothered by our presence" alt="Penguins on ice" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/img_6446')" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/20150217_095324" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_095324" data-caption="First light" alt="First light" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_095324')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/20150217_095348" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_095348" data-caption="Sun breaking through" alt="Sunrise" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_095348')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/20150217_091633" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_091633" data-caption="Golden hour on ice" alt="Golden light" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_091633')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/20150217_090228" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_090228" data-caption="Antarctica awakens" alt="Morning light" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_090228')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/20150217_090307" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_090307" data-caption="Ice in morning light" alt="Morning ice" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_090307')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/20150217_091022" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_091022" data-caption="The transformation" alt="Sunrise transformation" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_091022')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/petermann/20150217_091114" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_091114" data-caption="What we woke up for" alt="Antarctic sunrise" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/petermann/20150217_091114')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-5">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6464" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6464" data-caption="Fog and ice blur together" alt="Fog" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6464')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6465" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6465" data-caption="Cliffs hanging in the sky" alt="Cliffs in fog" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6465')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6470" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6470" data-caption="Where does the ice end?" alt="Ice and sky" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6470')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6475" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6475" data-caption="The world dissolves" alt="Fog landscape" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6475')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6472" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6472" data-caption="Eerie morning silence" alt="Morning silence" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6472')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-6">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6511" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6511" data-caption="The clouds begin to part" alt="Clouds parting" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6511')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6514" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6514" data-caption="Blue sky appears" alt="Blue sky" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6514')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6515" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6515" data-caption="The transformation" alt="Transformation" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6515')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6516" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6516" data-caption="Antarctica revealed" alt="Antarctica revealed" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6516')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6517" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6517" data-caption="Breathtaking" alt="Breathtaking view" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6517')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6521" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6521" data-caption="Worth the 4am wake-up" alt="Morning glory" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6521')" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6534" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6534" data-caption="Finally going ashore" alt="Going ashore" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6534')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6535" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6535" data-caption="On the ice" alt="On ice" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6535')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6538" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6538" data-caption="Crew day!" alt="Crew day" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6538')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6539" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6539" data-caption="Exploring" alt="Exploring" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6539')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6540" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6540" data-caption="Antarctica!" alt="Antarctica" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6540')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6546" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6546" data-caption="Taking it all in" alt="Taking it in" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6546')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6548" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6548" data-caption="Walking on Antarctica" alt="Walking" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6548')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6553" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6553" data-caption="Our turn at last" alt="Crew ashore" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6553')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-5">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6556" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6556" data-caption="The climb begins" alt="Climbing" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6556')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6558" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6558" data-caption="Penguins watching" alt="Penguins watching" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6558')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6559" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6559" data-caption="Our audience" alt="Penguin audience" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6559')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6563" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6563" data-caption="Getting higher" alt="Higher up" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6563')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6565" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6565" data-caption="Ready to sled" alt="Ready to sled" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6565')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6717" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6717" data-caption="Antarctica memories" alt="Memories" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6717')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/south-shetlands/img_6572" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6572" data-caption="Until next time" alt="Farewell" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/south-shetlands/img_6572')" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770826932/shiplife/st-tropez/sve0efvhgcxtzw24gzb8.jpg" class="story-image" data-caption="Approaching by tender - Port de Saint-Tropez." alt="Port de Saint-Tropez from tender" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770826933/shiplife/st-tropez/s0tmcuwwchbiedawytdl.jpg" class="story-image" data-caption="A cream Ferrari California parked at the harbor." alt="Ferrari at St. Tropez harbor" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">A cream Ferrari California parked casually by the marina. Just another day in St. Tropez.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_4767" class="story-image" data-caption="Black Legend - the kind of yacht you see in these waters." alt="Black Legend superyacht" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770826935/shiplife/st-tropez/dcqrued9fv0yivzmugge.jpg" class="story-image" data-caption="Musée de l'Annonciade." alt="Musée de l'Annonciade" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770826936/shiplife/st-tropez/uigff9kxp871azrxsvct.jpg" class="story-image" data-caption="Old town alley with church tower." alt="St. Tropez old town alley" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770826937/shiplife/st-tropez/xjz2ubcnhuzwe48tvrqv.jpg" class="story-image" data-caption="Narrow lane with ochre buildings." alt="St. Tropez lane" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770826938/shiplife/st-tropez/lekkbtf9cwl0uewqewer.jpg" class="story-image" data-caption="The Citadelle museum sign." alt="La Citadelle de Saint-Tropez" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">La Citadelle de Saint-Tropez - 400 years watching over the village.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770826939/shiplife/st-tropez/a20iloxqar6vpiqtpykw.jpg" class="story-image" data-caption="The tree-lined path to the fortress." alt="Path to La Citadelle" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about St. Tropez' : '+ More about St. Tropez'">+ More about St. Tropez</p>
 <div class="more-info-content">
 <p><strong>Bardot Effect:</strong> When Brigitte Bardot filmed "And God Created Woman" here in 1956, St. Tropez transformed overnight from fishing village to international destination.</p>
 <p><strong>Rosé Capital:</strong> The region produces more rosé than anywhere in France. The pale pink wine has become synonymous with St. Tropez summers.</p>
 <p><strong>The Pétanque:</strong> Beneath all the glamour, locals still gather in Place des Lices to play pétanque every evening. It's the most democratic spot in town.</p>
 <p><strong>Artist Colony:</strong> Before the celebrities came, St. Tropez attracted painters - Signac, Matisse, Bonnard - drawn by the extraordinary Mediterranean light.</p>
 </div>
 `,
 ...
 <div class="image-row image-row-6">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/ibiza/img_20140610_113541" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140610_113541" data-caption="Views from Dalt Vila" alt="Old town view" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140610_113541')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/ibiza/img_20140610_113551" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140610_113551" data-caption="The harbor below" alt="Harbor view" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140610_113551')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/ibiza/img_20140610_114901" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140610_114901" data-caption="Statue in the old town" alt="Statue" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140610_114901')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/ibiza/img_20140610_135036" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140610_135036" data-caption="The fortress walls" alt="Fortress walls" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140610_135036')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/ibiza/img_20140622_100836" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140622_100836" data-caption="Historic architecture" alt="Architecture" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140622_100836')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/ibiza/img_20140622_101517" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140622_101517" data-caption="Exploring the walled city" alt="Walled city" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140622_101517')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-3">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/ibiza/img_20140610_142859" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140610_142859" data-caption="Clipper ship in Ibiza harbor" alt="Clipper ship" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140610_142859')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/ibiza/img_20140610_113638" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140610_113638" data-caption="Tall ship rigging" alt="Rigging" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140610_113638')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/ibiza/img_20140610_143010" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140610_143010" data-caption="A different kind of Ibiza vessel" alt="Tall ship" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/ibiza/img_20140610_143010')" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/ibiza/img_20140622_121033" class="story-image" data-caption="Boy George in Ibiza" alt="Boy George" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770838414/shiplife/tierra-del-fuego/odt8wzc8m45rcucvu32i.jpg" class="story-image" data-caption="The dramatic horn peak rises from the channel." alt="Dramatic peak" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770838413/shiplife/tierra-del-fuego/eyl82br9yo8f3zt2wkbr.jpg" class="story-image" data-caption="View from Seabourn Quest sailing through the channel." alt="View from ship deck" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770838418/shiplife/tierra-del-fuego/caadlhdxp2xsmdspgg6v.jpg" class="story-image" data-caption="Ushuaia nestled beneath the Martial Mountains." alt="Ushuaia town" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770838417/shiplife/tierra-del-fuego/azocrgih4bpozyoyvsiu.jpg" class="story-image" data-caption="The jagged peaks of Tierra del Fuego." alt="Jagged peaks" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Melbourne' : '+ More about Melbourne'">+ More about Melbourne</p>
 <div class="more-info-content">
 <p><strong>Coffee Capital:</strong> Melbourne takes coffee more seriously than almost anywhere outside Italy. The laneway café culture here rivals any in the world.</p>
 <p><strong>Sports Obsessed:</strong> The Melbourne Cup horse race stops the entire nation. The AFL Grand Final fills the 100,000-seat MCG. Sport is religion here.</p>
 <p><strong>Street Art:</strong> Hosier Lane and the surrounding laneways are open-air galleries of ever-changing street art. The city embraces graffiti as culture.</p>
 <p><strong>Four Seasons in a Day:</strong> Melbourne's weather is famously unpredictable. Locals say if you don't like the weather, wait fifteen minutes.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768955757/IMG_6129_hwafyh.jpg" class="story-image" data-caption="Teatro Amazonas - the opera house in the jungle." alt="Teatro Amazonas exterior" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768955858/IMG_6071_yay66j.jpg" class="story-image" data-caption="Teatro Amazonas from the front." alt="Teatro Amazonas front" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768955835/IMG_6083_wcbeq4.jpg" class="story-image" data-caption="Inside the Teatro Amazonas." alt="Teatro Amazonas interior" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768955810/IMG_6104_ve9cwn.jpg" class="story-image" data-caption="Teatro Amazonas details." alt="Teatro Amazonas interior details" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768955785/IMG_6112_vqplpw.jpg" class="story-image" data-caption="At the Teatro Amazonas with the horse carriage." alt="Derrick at Teatro Amazonas with carriage" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768961199/IMG_6020_yyepgk.jpg" class="story-image" data-caption="On the Amazon River." alt="Amazon River" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768951523/Screenshot_20260120_142110_Facebook_sfqgia.jpg" class="story-image" data-caption="Holding a sloth - 2012 tributary excursion." alt="Derrick holding sloth" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Making a new friend on the tributary excursion.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768951523/Screenshot_20260120_142041_Facebook_qa7xiz.jpg" class="story-image" data-caption="The sloth wasn't in any hurry to leave." alt="Sloth closeup" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768951523/Screenshot_20260120_142055_Facebook_sdm2xc.jpg" class="story-image" data-caption="Baby alligator - tributary wildlife." alt="Baby gator" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,h_300,c_fill,g_north,q_auto,f_auto/v1768951604/Screenshot_20260120_134644_Facebook_vooudq.jpg" class="story-image" data-caption="Another young crocodilian friend." alt="Baby croc" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">The little ones are cute. The big ones... less so.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768951518/Screenshot_20260120_142140_Facebook_fladgt.jpg" class="story-image" data-caption="A curious monkey in the Amazon." alt="Monkey" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768951516/Screenshot_20260120_142200_Facebook_m2ofot.jpg" class="story-image" data-caption="Bird's nest in the canopy." alt="Tree with nest" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768951604/Screenshot_20260120_134703_Facebook_imcpbv.jpg" class="story-image" data-caption="A floating market along the tributary." alt="Jungle market" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768962276/IMG_6023_l1kkqd.jpg" class="story-image" data-caption="Lost in Manaus." alt="Lost in Manaus" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">This is the part where you start questioning your decisions.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768962223/IMG_6027_ymbkko.jpg" class="story-image" data-caption="Still lost in Manaus." alt="Still lost" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Still lost.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768962156/IMG_6032_rcjr8i.jpg" class="story-image" data-caption="Lost some more in Manaus." alt="Lost some more" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770838072/shiplife/santarem/bzanlghxizkmuowugqcv.jpg" class="story-image" data-caption="Blue church in Santarem." alt="Blue church in Santarem" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770838071/shiplife/santarem/is7l4twnkannboxi28q8.jpg" class="story-image" data-caption="Piranha for sale at the Santarem market." alt="Piranha fish in market" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770838070/shiplife/santarem/kgl5xmcw23uk75eg80j7.jpg" class="story-image" data-caption="Local riverboat with hammocks at Santarem." alt="Riverboat with sleeping passengers" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/v1770838076/shiplife/santarem/zhx72pnexjidruci7gh0.jpg" class="story-image" data-caption="Passengers waving from the riverboat." alt="Passengers waving" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">Sleeping in cots on one side, waving hello on the other - river life on the Amazon.</p>
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Santarém' : '+ More about Santarém'">+ More about Santarém</p>
 <div class="more-info-content">
 <p><strong>Meeting of Waters:</strong> Near Santarém, the clear Tapajós River meets the muddy Amazon. The waters run side by side without mixing for kilometers.</p>
 <p><strong>Gateway to Amazon:</strong> Santarém sits at the confluence of the Amazon and Tapajós rivers, making it a key port for exploring the Amazon basin.</p>
 <p><strong>Alter do Chão:</strong> The nearby village has beaches on the Tapajós that rival the Caribbean. National Geographic once called it Brazil's best beach.</p>
 <p><strong>Rubber Boom:</strong> Santarém prospered during the rubber boom of the late 1800s. Grand buildings from that era still line the waterfront.</p>
 </div>
...
an original composition inspired by this place.
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768952763/IMG_6391_Large_kingel.jpg" class="story-image" data-caption="The famous Selarón Steps - a mosaic tribute to Rio." alt="Selarón Steps with RIO letters" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768952612/IMG_6283_kikfgu.jpg" class="story-image" data-caption="Made it to the top - Cristo Redentor." alt="Derrick at Christ the Redeemer" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768953058/IMG_6305_qqetec.jpg" class="story-image" data-caption="The view from Corcovado." alt="View from Christ the Redeemer" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768952929/IMG_6333_gg6lzs.jpg" class="story-image" data-caption="Heading into the heart of the favela." alt="Entering the favela" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Heading into the heart of the favela.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768953014/IMG_6331_kvzk2o.jpg" class="story-image" data-caption="Life in the favela." alt="Favela street scene" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768952486/IMG_6346_lcg34g.jpg" class="story-image" data-caption="Taking a break with a popsicle." alt="Derrick eating popsicle in favela" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768952860/IMG_6350_kjpilj.jpg" class="story-image" data-caption="Another favela tour moment." alt="Favela tour" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768953816/IMG_6366_h1ih0q.jpg" class="story-image" data-caption="Copacabana Beach - where the chaos finally stops." alt="Copacabana Beach" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Copacabana. Worth every wrong turn.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/rio/copacabana-wave-sidewalk.jpg" class="story-image" data-caption="The famous wave-pattern sidewalk." alt="Copacabana promenade" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The famous wave-pattern sidewalk - designed by Roberto Burle Marx in 1970.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/rio/copacabana-palace-hotel.jpg" class="story-image" data-caption="Copacabana Palace." alt="Copacabana Palace hotel" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/rio/copacabana-beach-helicopter.jpg" class="story-image" data-caption="Beach life." alt="Copacabana beach" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">The iconic Copacabana Palace hotel, and the endless stretch of sand.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/rio/copacabana-volleyball-tournament.jpg" class="story-image" data-caption="Brasil vs USA beach volleyball." alt="Beach volleyball tournament" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/buzios/harbor-fishing-boats" class="story-image" data-caption="The harbor at Búzios - fishing boats and beach." alt="Búzios harbor" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The harbor at Búzios - fishing boats line the shore.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/buzios/ship-through-shops" class="story-image" data-caption="Seabourn framed through waterfront shops." alt="Ship through shops" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/buzios/yellow-church-locals" class="story-image" data-caption="The vibrant yellow church where locals gathered." alt="Yellow church" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The vibrant yellow church where locals gathered.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/buzios/water-taxis-pier" class="story-image" data-caption="Water taxis at the pier." alt="Water taxis" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Water taxis at the pier - Lucas, Maria Alice.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/buzios/fishermen-statues" class="story-image" data-caption="Bronze fishermen with Seabourn Quest in the background." alt="Fishermen statues" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/buzios/seagull-beach" class="story-image" data-caption="A seagull on the beach." alt="Seagull on beach" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The local wildlife seemed unimpressed by visitors.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/buzios/panoramic-hillside" class="story-image" data-caption="Panoramic view of Búzios." alt="Búzios panorama" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Panoramic view of Búzios - boats, hillside villas, and endless blue.</p>
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Búzios' : '+ More about Búzios'">+ More about Búzios</p>
 <div class="more-info-content">
 <p><strong>Bardot Effect:</strong> Búzios was an unknown fishing village until Brigitte Bardot vacationed here in 1964 with her Brazilian boyfriend. Overnight, it became internationally famous.</p>
 <p><strong>23 Beaches:</strong> The peninsula has 23 different beaches, each with its own character. Some face north for calm waters, others face south for better waves.</p>
 <p><strong>Rua das Pedras:</strong> The main street is paved with stones and lined with restaurants and boutiques. It's pedestrian-only and the heart of Búzios nightlife.</p>
 <p><strong>Year-Round Warmth:</strong> The microclimate keeps Búzios warm and dry year-round. Average temperatures stay between 22°C and 28°C even in winter.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/20150626_144805" class="story-image" data-caption="The Ligurian coast through fortress walls." alt="Coast through fortress window" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/img_5598" class="story-image" data-caption="View across the Gulf of La Spezia." alt="Gulf view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The Gulf of La Spezia spreads below - mountains, villages, and boats dotting the blue.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/img_5601" class="story-image" data-caption="Coastal panorama from the fortress." alt="Panorama" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">From up here, the Romantic poets found their inspiration.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/img_5575" class="story-image" data-caption="Fortress tower with coastal views." alt="Fortress tower" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">A weathered watchtower stands guard - eight centuries of salt wind and sun.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/img_5560" class="story-image" data-caption="Dramatic coastline view." alt="Coastal view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/20150626_143243" class="story-image" data-caption="The main piazza with colorful buildings and medieval tower." alt="Main piazza" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The piazza in full summer swing - cafes, palm trees, and the medieval tower standing watch.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/20150626_145954" class="story-image" data-caption="Street scene in Portovenere." alt="Street scene" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/img_5584" class="story-image" data-caption="Church domes against the sky." alt="Church domes" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Church domes rise against the Ligurian sky - San Lorenzo watching over the town.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/img_5596" class="story-image" data-caption="Town overlook." alt="Town view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Looking back at the fortress from the town below.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/img_5599" class="story-image" data-caption="Coastal scenery." alt="Coast" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The endless blue that drew poets to call this the Gulf of Poets.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/img_5607" class="story-image" data-caption="Village architecture." alt="Village" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Laundry dries on lines strung between centuries-old buildings.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/img_5610" class="story-image" data-caption="Harbor views." alt="Harbor" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The harbor where fishing boats have moored for generations.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/img_5611" class="story-image" data-caption="Final coastal view." alt="Coastal farewell" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">One last look at the coast that inspired some of English literature's greatest poems.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/img_5543" class="story-image" data-caption="Town square activity." alt="Square" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Summer crowds gather in the shade of the tower.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/img_5541" class="story-image" data-caption="The colorful piazza." alt="Piazza" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Pink, orange, yellow - the Mediterranean palette on full display.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portovenere/20150626_151743" class="story-image" data-caption="Farewell to Portovenere." alt="Farewell view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/saguenay/img_5881.jpg" class="story-image" data-caption="Golden hour on the Saguenay Fjord." alt="Saguenay Fjord with fall colors" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/saguenay/img_5886.jpg" class="story-image" data-caption="Village with rainbow." alt="Village along the Saguenay with rainbow" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/saguenay/img_5889.jpg" class="story-image" data-caption="Fall colors along the shore." alt="Village with fall colors" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/saguenay/img_5894.jpg" class="story-image" data-caption="Sunset from the ship's deck." alt="Ship deck with hot tub and sunset" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/saguenay/img_5899.jpg" class="story-image" data-caption="Sunset leaving the Saguenay." alt="Dramatic sunset over the fjord" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/florence/ivkqnq0u0hzydgzt3x8b.jpg" class="story-image" data-caption="The crowds on Via dei Calzaiuoli - everyone drawn to the same masterpiece." alt="Florence street view with Duomo" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/florence/ufgedwyqgznjp1lc9eqe.jpg" class="story-image" data-caption="The Piazza del Duomo - Baptistery under restoration with Brunelleschi's dome beyond." alt="Florence Duomo piazza" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/florence/loyudpbij2pkjbswt6ck.jpg" class="story-image" data-caption="The Duomo facade - pink, green, and white marble." alt="Duomo facade" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/florence/hsggthukftrjyjoua4ll.jpg" class="story-image" data-caption="Looking up at the Duomo - Gothic architecture reaching for the sky." alt="Duomo from below" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Looking up at the Duomo. The Gothic details overwhelming.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/florence/cmx8bmmxn1vxzx1a8pdu.jpg" class="story-image" data-caption="Giotto's Campanile beside the cathedral - 414 steps to the top." alt="Campanile and cathedral" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/florence/xdb1cnzsejvwnfd2f8sh.jpg" class="story-image" data-caption="Inside the Duomo - soaring vaults and stained glass." alt="Duomo interior" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The interior. Vasari's frescoes in the dome above. Pure Renaissance ambition.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/florence/xt5eedzzl9i6juwsfxuo.jpg" class="story-image" data-caption="The marble floor - centuries of footsteps have polished these stones." alt="Duomo marble floor" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/florence/cc0zgndlgc9kitvgnnod.jpg" class="story-image" data-caption="Horse carriage in the piazza - timeless Florence." alt="Horse carriage at Duomo" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/florence/d9kt2wakaxiwn4zeqo5c.jpg" class="story-image" data-caption="Renaissance sculpture - the masters are everywhere here." alt="Renaissance sculpture" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Sculpture everywhere. The Renaissance masters left their mark on every corner.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/florence/cohm7qm99uwvlazfwqwu.jpg" class="story-image" data-caption="Even the horses take a lunch break in Florence." alt="Horse feeding" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Even the horses get a lunch break. Everyone stops for food in Florence.</p>
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Florence' : '+ More about Florence'">+ More about Florence</p>
 <div class="more-info-content">
 <p><strong>Brunelleschi's Secret:</strong> The dome was built without wooden scaffolding using a herringbone brick pattern that is still not fully understood. Brunelleschi died before revealing his construction methods.</p>
 <p><strong>The Medici:</strong> The Medici family ruled Florence for 300 years and funded the Renaissance. Without their patronage, we might not have Michelangelo's David or Botticelli's Birth of Venus.</p>
 <p><strong>The Flood:</strong> In 1966, the Arno River flooded Florence, damaging thousands of artworks. Volunteers from around the world came to help, earning the nickname "Mud Angels."</p>
 <p><strong>Dante's City:</strong> Dante Alighieri was born here and wrote the Divine Comedy in Florentine dialect. His version of Italian became the basis for modern Italian.</p>
 </div>
 ...
 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Stromboli' : '+ More about Stromboli'">+ More about Stromboli</p>
 <div class="more-info-content">
 <p><strong>Lighthouse of the Mediterranean:</strong> Stromboli has been erupting continuously for at least 2,000 years. Ancient sailors used its glow to navigate at night.</p>
 <p><strong>Strombolian Eruptions:</strong> The volcano's distinctive eruption style - rhythmic bursts of lava every 10-20 minutes - gave its name to a type of volcanic activity studied worldwide.</p>
 <p><strong>Sciara del Fuoco:</strong> The "Stream of Fire" is a massive scar on the volcano's side where lava flows into the sea. Watching it at night from a boat is unforgettable.</p>
 <p><strong>Tiny Population:</strong> Fewer than 500 people live on Stromboli year-round. The island has no cars and limited electricity.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/v1771801365/shiplife/sanremo/coastal-path-cliffs.jpg" class="story-image" data-caption="The coastal bike path." alt="Coastal bike path" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771801367/shiplife/sanremo/coastal-cliffs-blue-sea.jpg" class="story-image" data-caption="Cliffs and blue sea." alt="Mediterranean coastline" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771801366/shiplife/sanremo/bike-path-railings.jpg" class="story-image" data-caption="The path along the water." alt="Bike path" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/v1771801371/shiplife/sanremo/rocky-cove-beach.jpg" class="story-image" data-caption="A hidden cove along the route." alt="Rocky cove beach" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/v1771801369/shiplife/sanremo/colorful-harbor-reflection.jpg" class="story-image" data-caption="A Riviera harbor." alt="Colorful harbor" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771801374/shiplife/sanremo/striped-church-facade.jpg" class="story-image" data-caption="Ligurian church." alt="Striped church facade" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771801370/shiplife/sanremo/coastal-hillside-villas.jpg" class="story-image" data-caption="Hillside villas." alt="Coastal villas" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/v1771801372/shiplife/sanremo/casino-sanremo.jpg" class="story-image" data-caption="The Casino Sanremo." alt="Casino Sanremo" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Casino Sanremo - where Belle Époque glamour still lives on the Italian Riviera.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771801373/shiplife/sanremo/teatro-ariston.jpg" class="story-image" data-caption="Teatro Ariston." alt="Teatro Ariston" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771801373/shiplife/sanremo/casino-boulevard.jpg" class="story-image" data-caption="The main boulevard." alt="San Remo boulevard" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771801378/shiplife/sanremo/ornate-stone-archway.jpg" class="story-image" data-caption="Medieval gateway." alt="Stone archway" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771801377/shiplife/sanremo/medieval-piazza.jpg" class="story-image" data-caption="Hidden piazza." alt="Medieval piazza" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/v1771801375/shiplife/sanremo/green-baroque-church.jpg" class="story-image" data-caption="Baroque church." alt="Green baroque church" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771801379/shiplife/sanremo/produce-market.jpg" class="story-image" data-caption="Fresh market produce." alt="Produce market" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/v1771801380/shiplife/sanremo/violin-sculpture.jpg" class="story-image" data-caption="Public art." alt="Violin sculpture" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/v1771801368/shiplife/sanremo/garden-path.jpg" class="story-image" data-caption="Mediterranean gardens." alt="Garden path" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row image-row-5">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/img_5253" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5253" data-caption="View across the bay" alt="Bay view" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5253')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/img_5249" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5249" data-caption="Roses harbor" alt="Harbor view" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5249')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/img_5245" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5245" data-caption="Boats in the marina" alt="Marina" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5245')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/20150623_115457" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/20150623_115457" data-caption="Along the coast" alt="Coastal view" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/20150623_115457')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/img_5251" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5251" data-caption="The citadel walls" alt="Citadel" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5251')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-6">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/img_5256" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5256" data-caption="Exploring the town" alt="Town street" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5256')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/img_5257" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5257" data-caption="Local architecture" alt="Architecture" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5257')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/img_5265" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5265" data-caption="Town scene" alt="Town scene" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5265')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/img_5254" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5254" data-caption="Catalan details" alt="Details" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5254')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/img_5246" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5246" data-caption="Along the promenade" alt="Promenade" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5246')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/20150623_142632" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/20150623_142632" data-caption="Afternoon wandering" alt="Afternoon" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/20150623_142632')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-6">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/img_5258" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5258" data-caption="Saucisson display" alt="Saucisson" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5258')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/img_5259" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5259" data-caption="Market treasures" alt="Market goods" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5259')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/img_5261" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5261" data-caption="Local specialties" alt="Specialties" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5261')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/roses/img_5262" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5262" data-caption="Catalan flavors" alt="Catalan goods" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/roses/img_5262')" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770837624/shiplife/propriano/mjbl4cx4xrjho22ofuea.jpg" class="story-image" data-caption="A ceramic map of the Mediterranean - Corsica at the crossroads." alt="Mediterranean map on stone wall" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770837629/shiplife/propriano/ekwfyssb8q2frhlj50hc.jpg" class="story-image" data-caption="Street art portraits on a Propriano construction fence." alt="Street art murals" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1770837627/shiplife/propriano/jq4qono8ktjipgnqo3ma.jpg" class="story-image" data-caption="Church spire rising above the Corsican landscape." alt="Propriano landscape with church" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768951551/Screenshot_20260120_140907_Facebook_kw0y1a.jpg" class="story-image" data-caption="The Old Port of Marseille with Fort Saint-Jean." alt="Marseille Old Port" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/marseille/20150809_102506" class="story-image" data-caption="Fort Saint-Jean guards the harbor entrance." alt="Fort Saint-Jean" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/marseille/img_20140606_093315" class="story-image" data-caption="MuCEM - the latticed cube that redefined Marseille's waterfront." alt="MuCEM exterior" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">MuCEM's striking architecture drew me in from the port.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/marseille/img_20140606_123656" class="story-image" data-caption="Ancient water wheel - Mediterranean engineering preserved." alt="Water wheel" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Ancient engineering - a water wheel that once sustained life around the sea.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/marseille/img_20140606_130225" class="story-image" data-caption="Navigation instruments - astrolabes and sextants." alt="Navigation instruments" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/marseille/img_20140606_131050" class="story-image" data-caption="Carnival costumes from across Europe and the Mediterranean." alt="Carnival costumes" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/marseille/20150711_150950" class="story-image" data-caption="The Old Port with Notre Dame de la Garde visible on the hill." alt="Old Port with basilica" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">From the port, she's always there - golden statue glinting in the sun. The walk calls.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/marseille/20150809_103456" class="story-image" data-caption="Street signs pointing to Notre Dame de la Garde." alt="Direction signs" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The signs point upward. Always upward.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/marseille/20150809_104124" class="story-image" data-caption="Notre Dame de la Garde emerges through the trees." alt="Basilica through trees" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Through the pines, she appears - closer with every switchback.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/marseille/20150809_111645" class="story-image" data-caption="View from Notre Dame de la Garde to the Frioul islands." alt="Island view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/marseille/20150809_113332" class="story-image" data-caption="Tourists on the terrace at Notre Dame de la Garde." alt="Summit terrace" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Everyone catches their breath here. The climb is worth every step.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/marseille/img_5518" class="story-image" data-caption="Notre Dame de la Garde - La Bonne Mère watches over Marseille." alt="Notre Dame de la Garde" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row image-row-5">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/le-lavandou/img_20140605_122522" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/img_20140605_122522" data-caption="Arriving in Le Lavandou" alt="Arrival" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/img_20140605_122522')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/le-lavandou/20150807_124809" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/20150807_124809" data-caption="The Mediterranean shore" alt="Shore" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/20150807_124809')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/le-lavandou/img_20140605_134242" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/img_20140605_134242" data-caption="Côte d'Azur views" alt="Coast view" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/img_20140605_134242')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/le-lavandou/img_20140605_135015" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/img_20140605_135015" data-caption="Beach day" alt="Beach" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/img_20140605_135015')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/le-lavandou/20150613_130635" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/20150613_130635" data-caption="The waterfront" alt="Waterfront" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/20150613_130635')" style="cursor:pointer">
 </div>
 ...
 <div class="image-row image-row-5">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/le-lavandou/20150613_131906" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/20150613_131906" data-caption="Town streets" alt="Town" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/20150613_131906')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/le-lavandou/20150613_135211" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/20150613_135211" data-caption="Afternoon exploring" alt="Exploring" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/20150613_135211')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/le-lavandou/20150613_190342" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/20150613_190342" data-caption="Evening light" alt="Evening" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/20150613_190342')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/le-lavandou/20150613_134743" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/20150613_134743" data-caption="Local color" alt="Local scene" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/20150613_134743')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/le-lavandou/20150611_104847" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/20150611_104847" data-caption="Le Lavandou charm" alt="Town charm" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/le-lavandou/20150611_104847')" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_4805" class="story-image" data-caption="Luxury yachts moored beneath the palace rock." alt="Yachts and palace" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The palace watches over its floating subjects.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_7158" class="story-image" data-caption="A Lürssen superyacht complete with its own helicopter." alt="Superyacht with helicopter" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_7140" class="story-image" data-caption="The Casino de Monte-Carlo and its famous gardens." alt="Casino and gardens" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The Casino de Monte-Carlo - where Belle Époque architecture meets modern excess.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_7136" class="story-image" data-caption="The ornate facade of the Monte Carlo Casino." alt="Casino facade" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_4790" class="story-image" data-caption="A typical Monaco street - Belle Époque elegance." alt="Monaco street" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Even the side streets feel like a film set.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_4782" class="story-image" data-caption="Looking down toward the harbor, the cruise ship waiting." alt="Street to harbor" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Every street seems to lead back to the sea - and your ship waiting in the harbor.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_7152" class="story-image" data-caption="A small chapel dwarfed by modern towers above." alt="Chapel and towers" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_4783" class="story-image" data-caption="Grand Prix ticket booth with F1 cars on display." alt="Grand Prix booth" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The Grand Prix is never far from anyone's mind here.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_4784" class="story-image" data-caption="The Monaco Grand Prix circuit map - through city streets and tunnel." alt="Circuit map" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_4791" class="story-image" data-caption="Race cars on the Monaco circuit - visible through the barriers." alt="Grand Prix racing" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_5618" class="story-image" data-caption="Cannonballs stacked on the old fortress walls, the city below." alt="Fortress cannons" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_5630" class="story-image" data-caption="An octopus sculpture in the palace gardens." alt="Octopus sculpture" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Prince Albert's commitment to ocean conservation shows up in unexpected places.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_20140702_101103" class="story-image" data-caption="Cousteau's yellow submarine outside the Oceanographic Museum." alt="Cousteau submarine" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_20140702_124632" class="story-image" data-caption="Hermes by Arman (1987) in the gardens." alt="Hermes sculpture" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Modern art meets Mediterranean gardens - Arman's Hermes stands watch over the sea.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_5636" class="story-image" data-caption="Romantic sculpture surrounded by flowers in the gardens." alt="Garden sculpture" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_4799" class="story-image" data-caption="A Monaco cheese shop - dozens of varieties." alt="Cheese shop" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">A proper cheese selection. This is still France, after all - or close enough.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_4800" class="story-image" data-caption="French pastries in a Monaco patisserie." alt="Pastry display" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Every pastry is a small work of art. The prices reflect the zip code.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_20140702_115517" class="story-image" data-caption="Lunch in Monaco - lasagna, salad, and white wine." alt="Monaco lunch" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_4807" class="story-image" data-caption="A red Ferrari 458 parked casually on a Monaco street." alt="Ferrari" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Just another car parked on a Monaco street. Here, this is ordinary.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_4768" class="story-image" data-caption="White Rolls-Royce Phantom Drophead with custom chrome wheels." alt="Rolls-Royce" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">A Rolls-Royce Phantom Drophead - because why not?</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_5613" class="story-image" data-caption="Amadeus (70m) and Dubai (162m) - legendary superyachts side by side." alt="Amadeus and Dubai superyachts" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/monte-carlo/img_20140602_092703" class="story-image" data-caption="Lady Moura - her name spelled in 24-karat gold." alt="Lady Moura superyacht" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/corfu/img_4684" class="story-image" data-caption="The Venetian moat with boats." alt="Fortress moat" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The moat between old and new fortress - once a defense, now a quiet marina.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/corfu/img_4691" class="story-image" data-caption="Inside the fortress walls." alt="Fortress interior" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Inside the fortress walls - layers of history from Byzantine to British.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/corfu/img_4692" class="story-image" data-caption="Fortress architecture." alt="Fortress view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Venetian engineering built to withstand Ottoman sieges.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/corfu/img_4702" class="story-image" data-caption="Clock tower and colorful buildings." alt="Town view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The clock tower rises above pastel buildings - Greek, Venetian, British all at once.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/corfu/img_4705" class="story-image" data-caption="Fortress ramparts with cannons." alt="Fortress cannons" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Cannons still guard the ramparts, pointed at an enemy that never comes.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/corfu/img_4679" class="story-image" data-caption="Harbor view from the fortress." alt="Harbor view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-47-colorful" class="story-image" data-caption="Kek Lok Si Temple - one of the largest Buddhist temples in Southeast Asia." alt="Kek Lok Si Temple" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-15-colorful" class="story-image" data-caption="Every surface alive with color." alt="Colorful temple" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-18-temple" class="story-image" data-caption="Intricate temple details." alt="Temple details" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-24-temple" class="story-image" data-caption="Stunned and amazed." alt="Temple" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-45-food-place" class="story-image" data-caption="Hokkien mee - the signature dish of Penang." alt="Hokkien mee" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-46-food-place" class="story-image" data-caption="A delicious surprise." alt="Lunch in Penang" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-49-colorful" class="story-image" data-caption="More visual overload." alt="Temple scene" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-51-colorful" class="story-image" data-caption="Elaborate details everywhere." alt="Temple scene" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-53-colorful" class="story-image" data-caption="Wandering in a daze." alt="Temple scene" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-63-colorful" class="story-image" data-caption="Continuing the colorful journey." alt="Temple scene" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-64-colorful" class="story-image" data-caption="One of many memorable moments." alt="Temple scene" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <p>Then we headed up Penang Hill, or <em>Bukit Bendera</em> in Malay. At 833 meters, it's been a retreat from the tropical heat since the 1780s when British colonials first established it as a hill station. They used to be carried up in sedan chairs by teams of porters. In 1923, the Swiss-built funicular railway opened, one of the steepest tunnel railways in the world.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-88-hill-ascent" class="story-image" data-caption="Beginning the ascent up Penang Hill." alt="Penang Hill ascent" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-89-penang-hill" class="story-image" data-caption="Making our way up." alt="Penang Hill" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-65-overlook" class="story-image" data-caption="The view that blew my mind." alt="Overlook view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-67-overlook" class="story-image" data-caption="Looking out over the island." alt="Overlook view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-68-overlook" class="story-image" data-caption="The strait and the city below." alt="Overlook view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-83-overlook" class="story-image" data-caption="Everything visible from the top." alt="Overlook view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-84-overlook" class="story-image" data-caption="A day well spent." alt="Overlook view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/penang/penang-91-hilltop-view" class="story-image" data-caption="Views from the summit." alt="Hilltop view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Penang' : '+ More about Penang'">+ More about Penang</p>
 <div class="more-info-content">
 <p><strong>Food Capital:</strong> Penang is widely considered the food capital of Malaysia. The street food here draws pilgrims from around the world - char kway teow, laksa, nasi kandar.</p>
 <p><strong>UNESCO George Town:</strong> The historic center of George Town is a UNESCO World Heritage site, recognized for its unique multicultural architectural heritage.</p>
 <p><strong>Street Art:</strong> Ernest Zacharevic's murals transformed George Town's walls into an open-air gallery. "Kids on Bicycle" became one of Asia's most photographed artworks.</p>
 <p><strong>Clan Jetties:</strong> Chinese clan communities built wooden jetty villages over the water in the 19th century. Several still exist, with families living in traditional stilt houses.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto,a_90/shiplife/dubai/burj_khalifa_selfie" class="story-image" data-caption="Standing at the base of the world's tallest building." alt="At the Burj Khalifa" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/dubai/downtown_skyline" class="story-image" data-caption="Downtown Dubai's forest of towers." alt="Downtown Dubai skyline" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/dubai/address_hotel" class="story-image" data-caption="The Address Downtown with Dubai Mall." alt="The Address Downtown hotel" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/dubai/ice_rink" class="story-image" data-caption="Olympic-sized ice rink inside the mall." alt="Dubai Mall ice rink" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">An Olympic-sized ice rink. In a mall. In the desert. Because why not?</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/dubai/car_show_overview" class="story-image" data-caption="Car show floor inside Dubai Mall." alt="Dubai Mall car show" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/dubai/mercedes_gullwing" class="story-image" data-caption="1955 Mercedes-Benz 300SL Gullwing - one of the most valuable cars ever made." alt="Mercedes Gullwing" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto,a_180/shiplife/dubai/lamborghini" class="story-image" data-caption="Lamborghini Aventador on display." alt="Lamborghini Aventador" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/dubai/aquarium_wall" class="story-image" data-caption="The massive aquarium wall towers over shoppers." alt="Dubai Mall aquarium" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/dubai/aquarium_crowd" class="story-image" data-caption="Visitors mesmerized by the three-story viewing panel." alt="Aquarium viewing area" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">People line up just to stare. The viewing panel is the size of a basketball court.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/dubai/aquarium_portrait" class="story-image" data-caption="Posing in front of the 10-million-liter tank." alt="Portrait at the aquarium" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/dubai/brunetti_cafe" class="story-image" data-caption="Brunetti cafe with the aquarium glowing in the background." alt="Brunetti cafe" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The cafe sits in the shadow of the aquarium, its blue glow adding ambiance you can't buy.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/dubai/waffles" class="story-image" data-caption="Belgian waffles at Brunetti - Dubai style." alt="Brunetti waffles" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/dubai/waterfall_fountain" class="story-image" data-caption="The Human Waterfall - silver divers frozen in eternal freefall." alt="Dubai Mall waterfall fountain" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The Human Waterfall - one last moment of impossibility before heading back to the ship.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/dubai/taxi_goodbye" class="story-image" data-caption="Saying goodbye to the Dubai skyline." alt="Dubai skyline from taxi" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
...
an original composition inspired by this place.
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/istanbul/vnej55ugldrfwracvzx9.jpg" class="story-image" data-caption="Ferries crossing the Bosphorus - the waterway between continents." alt="Bosphorus ferry traffic" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/istanbul/aq0wvlrvxxxsdacnhk2z.jpg" class="story-image" data-caption="Rumeli Fortress - built in four months to control the strait." alt="Rumeli Fortress" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Rumeli Fortress. Built to strangle Constantinople. It worked.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/istanbul/zqnboqzhapitzuotpqpo.jpg" class="story-image" data-caption="The fortress towers still guard the narrowest point of the strait." alt="Rumeli Fortress with boat" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/istanbul/tu96jp4v9f92xavpkvj1.jpg" class="story-image" data-caption="Hillside houses along the Bosphorus waterfront." alt="Istanbul waterfront" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/istanbul/bwbepgnsrznraz5tghiq.jpg" class="story-image" data-caption="The Republic Monument - commemorating Turkish independence." alt="Taksim Monument" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The Republic Monument. Atatürk's revolution started a new chapter for Turkey.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/istanbul/xyxeo1jq28rmivmihrzr.jpg" class="story-image" data-caption="Taksim Square - where Istanbul's past and present collide." alt="Taksim Square" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/istanbul/jsykrluoapxnb6354eok.jpg" class="story-image" data-caption="A mosque glimpsed through the green hillsides." alt="Istanbul mosque view" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">A glimpse of a mosque through the hillsides. They're everywhere.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/v1771203420/shiplife/istanbul/hqoefaykny2gyjsn96e9.jpg" class="story-image" data-caption="Ottoman architecture being preserved for future generations." alt="Mosque dome" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Restoration in progress. Istanbul never stops preserving its past.</p>
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Istanbul' : '+ More about Istanbul'">+ More about Istanbul</p>
 <div class="more-info-content">
 <p><strong>Three Names:</strong> The city has been Byzantium, Constantinople, and Istanbul. The name changed officially in 1930, but locals had been calling it Istanbul for centuries.</p>
 <p><strong>Two Continents:</strong> Istanbul is the only city in the world that straddles two continents. The Bosphorus strait separates Europe from Asia.</p>
 <p><strong>Hagia Sophia:</strong> For nearly 1,000 years, Hagia Sophia was the largest cathedral in the world. It became a mosque, then a museum, and is now a mosque again.</p>
 <p><strong>The Grand Bazaar:</strong> One of the oldest and largest covered markets in the world, with over 4,000 shops across 61 streets. It has been operating since 1461.</p>
 </div>
...
an original composition inspired by this place.
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/yalta/img_3336" class="story-image" data-caption="Yalta - the Russian Riviera on the Black Sea." alt="Yalta waterfront" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/yalta/img_3338" class="story-image" data-caption="Crimean coast architecture." alt="Yalta architecture" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Where Tsars once summered and writers found their muse.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/yalta/img_3345" class="story-image" data-caption="The Crimean coastline." alt="Crimean coast" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/yalta/img_3347" class="story-image" data-caption="Layers of history on the Black Sea coast." alt="Yalta scene" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Yalta' : '+ More about Yalta'">+ More about Yalta</p>
 <div class="more-info-content">
 <p><strong>Yalta Conference:</strong> In February 1945, Roosevelt, Churchill, and Stalin met at the Livadia Palace to plan the post-war world. The decisions made here shaped the Cold War.</p>
 <p><strong>Russian Riviera:</strong> Yalta was the summer playground of Russian aristocracy. Tsars built palaces along the coast, and Chekhov wrote some of his greatest works here.</p>
 <p><strong>Swallow's Nest:</strong> The fairytale castle perched on a cliff has become Ukraine's most photographed landmark, despite being barely over 100 years old.</p>
 <p><strong>Subtropical Climate:</strong> Sheltered by the Crimean Mountains, Yalta has the warmest climate in Ukraine. Vineyards and palm trees thrive in the mild winters.</p>
 </div>
...
an original composition inspired by this place.
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/venice/memsil77lclgh3on0xqv.jpg" alt="St. Mark's" data-caption="The Campanile and Doge's Palace from the lagoon - the view that launched a thousand paintings." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/venice/subvvj68x70jjlrmetwd.jpg" alt="Seabourn name" data-caption="Seabourn Odyssey - 32,000 tons of floating luxury, but small enough to reach Venice." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/venice/pcrxgne7lfvltufyldao.jpg" alt="Water taxi" data-caption="Water taxi approaching the ship - our floating home in Venice." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/venice/dd0ujjlypmrzkcsjfysv.jpg" alt="Grand Canal" data-caption="Palazzos and churches slide past the water taxi window." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/venice/kososcn3vkjncknnp2xl.jpg" alt="Molino Stucky" data-caption="The Molino Stucky - a 19th-century flour mill now reborn as a Hilton." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/venice/fbbnjwmpcti64jsveq24.jpg" alt="Gesuati" data-caption="Chiesa dei Gesuati on Zattere - Tiepolo frescoes hide behind this facade." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/venice/cvpd1i1wb2b8ysqvpl6h.jpg" alt="Redentore" data-caption="Chiesa del Redentore - Palladio built it to celebrate the end of the plague." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/venice/yzwkbp6jfbopfwa1cqxg.jpg" alt="Salute" data-caption="Santa Maria della Salute - the baroque sentinel at the mouth of the Grand Canal." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/venice/ubmxlfji9t6ltpugk41h.jpg" alt="Ship at dock" data-caption="The Seabourn Odyssey at her Venice berth - one of cruising's most coveted ports." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Venice' : '+ More about Venice'">+ More about Venice</p>
 <div class="more-info-content">
 <p><strong>118 Islands:</strong> Venice is built on 118 small islands connected by over 400 bridges. The entire city rests on wooden pilings driven into the mud.</p>
 <p><strong>Sinking City:</strong> Venice sinks about 1-2 millimeters per year while sea levels rise. The MOSE flood barrier system was completed in 2020 to protect the lagoon.</p>
 <p><strong>No Cars:</strong> Venice is the largest urban car-free zone in Europe. Everything moves by boat or on foot through the narrow calli (streets).</p>
 <p><strong>Murano Glass:</strong> Glassmakers were moved to Murano island in 1291 to prevent fires and keep trade secrets. The tradition continues today.</p>
 </div>
...
an original composition inspired by this place.
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/hvar/img_3640" class="story-image" data-caption="Hvar's harbor - where superyachts meet ancient stone." alt="Hvar harbor" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The harbor where superyachts moor against ancient Venetian walls.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/hvar/img_3644" class="story-image" data-caption="The marble streets of Hvar town." alt="Hvar streets" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/hvar/img_3650" class="story-image" data-caption="Views from the fortress - islands scattered across the Adriatic." alt="View from fortress" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">From the fortress walls - islands scattered like emeralds across the Adriatic.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/hvar/img_3656" class="story-image" data-caption="The Adriatic stretches to the horizon." alt="Adriatic view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Hvar' : '+ More about Hvar'">+ More about Hvar</p>
 <div class="more-info-content">
 <p><strong>Oldest Theatre:</strong> Hvar has one of the oldest public theatres in Europe, built in 1612. It was open to all citizens regardless of class.</p>
 <p><strong>Lavender Island:</strong> Hvar is famous for its lavender. The purple fields bloom in June and July, and lavender products are sold everywhere.</p>
 <p><strong>Venetian Legacy:</strong> Venice ruled Hvar for nearly 400 years (1420-1797). The Venetian lion still appears on buildings throughout the old town.</p>
 <p><strong>Party Island:</strong> Modern Hvar has become Croatia's party capital. Beach clubs on the Pakleni Islands and bars along the harbor draw the international jet set.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/constanta/img_3296" class="story-image" data-caption="Constanța's pedestrian quarter - old European charm on the Black Sea." alt="Constanta old town street" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Constanța's pedestrian quarter - old European charm on the Black Sea.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/constanta/img_3297" class="story-image" data-caption="Summer afternoon in the city center." alt="Fountain square in Constanta" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/constanta/img_3299" class="story-image" data-caption="Beach cabanas at Mamaia - Romania's summer playground." alt="Mamaia beach resort" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Beach cabanas at Mamaia - Romania's summer playground.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/constanta/img_3298" class="story-image" data-caption="Mamaia nightlife - shots for 3 Lei." alt="Megalos Summer Club Mamaia" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Mamaia nightlife - shots for 3 Lei.</p>
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Constanța' : '+ More about Constanța'">+ More about Constanța</p>
 <div class="more-info-content">
 <p><strong>Ovid's Exile:</strong> The Roman poet Ovid was exiled here by Emperor Augustus in 8 AD. He spent his final years writing sorrowful letters home. His statue stands in the old town square.</p>
 <p><strong>Ancient Tomis:</strong> Greeks founded the city as Tomis around 600 BC. The name Constanța comes from Constantia, sister of Emperor Constantine.</p>
 <p><strong>Mamaia:</strong> Romania's most popular beach resort stretches 8 kilometers along a narrow sandbar. In summer, it transforms into a 24-hour party scene.</p>
 <p><strong>The Casino:</strong> The art nouveau Casino on the seafront is one of Romania's most iconic buildings, though it has been abandoned for decades awaiting restoration.</p>
 </div>
 `,
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/katakolon/img_3597" class="story-image" data-caption="The best way to see Greece." alt="Scooter mirror selfie" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/katakolon/img_3600" class="story-image" data-caption="Greek countryside - ancient ruins hiding in plain sight." alt="Rural Greece with ruins" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/katakolon/img_3602" class="story-image" data-caption="Found it. A hidden cove away from the cruise crowds." alt="Beach cove with scooters" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/katakolon/img_3594" class="story-image" data-caption="Katakolon's waterfront - tavernas and blue awnings." alt="Greek waterfront promenade" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Katakolon's waterfront - tavernas and blue awnings.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/katakolon/img_3592" class="story-image" data-caption="Lunch with a view." alt="Waterfront cafe" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Lunch with a view.</p>
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Katakolon' : '+ More about Katakolon'">+ More about Katakolon</p>
 <div class="more-info-content">
 <p><strong>Gateway to Olympia:</strong> Ancient Olympia is 35 kilometers inland. The Olympic Games were held here every four years from 776 BC until 393 AD.</p>
 <p><strong>The Flame:</strong> The Olympic torch is still lit at Olympia using the sun's rays and a parabolic mirror, then carried to whichever city is hosting the games.</p>
 <p><strong>Small Town:</strong> Katakolon itself has fewer than 600 permanent residents. The population swells dramatically when cruise ships arrive.</p>
 <p><strong>Railway:</strong> A historic train used to connect Katakolon to Olympia. The old railway station and some carriages remain as monuments to that era.</p>
 </div>
 `,
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_80,f_auto/shiplife/odessa/odessa-cathedral-park" class="story-image" data-caption="Transfiguration Cathedral from the park - pigeons scatter across the cobblestones." alt="Cathedral from park" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/odessa/odessa-vorontsov-monument" class="inline-image" data-caption="At the Vorontsov monument - the man who built modern Odessa." alt="Vorontsov monument" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/odessa/odessa-ornate-facade" class="inline-image" data-caption="Ornate facades with caryatids - echoes of empire on every street." alt="Ornate facade" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_80,f_auto/shiplife/odessa/odessa-cathedral-closeup" class="story-image" data-caption="The cathedral's dome and bell tower - neoclassical splendor." alt="Cathedral closeup" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/odessa/odessa-cafe-candid" class="inline-image" data-caption="Settling into a sidewalk café." alt="Café scene" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/odessa/odessa-cafe-meal" class="inline-image" data-caption="Omelette and bruschetta - a leisurely afternoon." alt="Café meal" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Odessa' : '+ More about Odessa'">+ More about Odessa</p>
 <div class="more-info-content">
 <p><strong>Potemkin Steps:</strong> The famous staircase has 192 steps designed with an optical illusion - from the bottom only the landings are visible, from the top only the steps.</p>
 <p><strong>City of Humor:</strong> Odessa is known throughout the former Soviet world for its distinctive humor. April 1st is celebrated as Humorina, a city-wide comedy festival.</p>
 <p><strong>Catacombs:</strong> Beneath the city lies 2,500 kilometers of limestone tunnels - the largest catacomb network in the world. Partisans hid here during WWII.</p>
 <p><strong>Cosmopolitan Past:</strong> Founded in 1794, Odessa was designed as a free port. Greeks, Jews, Italians, and French all shaped its culture, giving it a uniquely cosmopolitan character.</p>
 </div>
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/mykonos/iqhfkemtntijyhepfxae.jpg" alt="Cruise ship" data-caption="Our home at anchor - the ship waits while Mykonos works its magic." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/mykonos/ovx558ltylc7yriwzfgt.jpg" alt="Harbor" data-caption="The old harbor - blue dome, turquoise water, and the whitewashed town climbing the hill." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/mykonos/fckjor4pfggvnkwwqgqa.jpg" alt="White alley" data-caption="The maze of Chora - every turn reveals another whitewashed wonder." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row-2">
 <img class="inline-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/mykonos/img_3130" alt="Red shutters" data-caption="Iconic Cycladic detail - red shutters against brilliant white." onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img class="inline-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/mykonos/img_3131" alt="Blue window" data-caption="Turquoise window framing the endless blue." onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/mykonos/yyv27n0rvlksrcn29dgy.jpg" alt="Flower alley" data-caption="Geraniums spill down whitewashed steps - the Cyclades in a single frame." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/mykonos/lw2ayxd2wwuetcb0jvdq.jpg" alt="Bougainvillea" data-caption="Bougainvillea cascades over a doorway - red against white, the eternal colors of Greece." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/mykonos/kx8jgpebx94sjtsx1gv1.jpg" alt="Paraportiani" data-caption="Paraportiani - five churches fused into one, the most photographed building in Greece." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/mykonos/awo8a2q078lvol6d4dop.jpg" alt="Petros crowd" data-caption="Petros holds court - tourists gather while the pelican preens." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/mykonos/vqfcb2cffwofro0yhdmb.jpg" alt="Petros close-up" data-caption="Petros knows he's famous - and expects to be treated accordingly." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="image-row-2">
 <img class="inline-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/mykonos/img_3128" alt="Little Venice" data-caption="Little Venice from the water - balconies hanging over the waves." onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img class="inline-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_auto,f_auto/shiplife/mykonos/img_3129" alt="Waterfront houses" data-caption="Houses built so close the spray reaches the doors." onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/mykonos/foehrmtcpagjgldkjps7.jpg" alt="Windmills" data-caption="The windmills of Kato Mili - grinding grain for 400 years, now grinding out postcards." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/mykonos/img_3145" alt="Windmill ridge" data-caption="The windmill ridge at golden hour - thatch and stone against the sky." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img class="story-image" src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/mykonos/img_3148" alt="Harbor panorama" data-caption="Harbor panorama with the windmills standing guard - the definitive Mykonos view." onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Mykonos' : '+ More about Mykonos'">+ More about Mykonos</p>
 <div class="more-info-content">
 <p><strong>Island of Winds:</strong> Mykonos is known as the Island of the Winds. The iconic windmills were built in the 16th century to harness the constant breezes for grinding grain.</p>
 <p><strong>Little Venice:</strong> The colorful houses of Little Venice were built right at the water's edge by wealthy merchants. Balconies hang directly over the sea.</p>
 <p><strong>Pelican Mascot:</strong> The island's mascot is Petros the Pelican, whose predecessor arrived in 1954 and became beloved by locals. There's always a Petros wandering the waterfront.</p>
 <p><strong>Party Island:</strong> Mykonos became a gay-friendly destination in the 1970s and evolved into one of the world's premier party islands. The clubs don't get going until well after midnight.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/nafplion/img_2944" class="story-image" data-caption="Nafplio's old town - Greece's first capital." alt="Nafplio town" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The old town spreads out in a maze of Venetian architecture and neoclassical buildings.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/nafplion/img_2950" class="story-image" data-caption="Streets of Nafplio." alt="Nafplio streets" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/nafplion/img_2965" class="story-image" data-caption="View from Palamidi Fortress." alt="Fortress view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The view from the ancient stone windows - Nafplio spreads below like a map.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/nafplion/img_2972" class="story-image" data-caption="Palamidi Fortress walls." alt="Fortress walls" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/nafplion/img_2975" class="story-image" data-caption="Nafplio's charming details." alt="Nafplio details" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Nafplio' : '+ More about Nafplio'">+ More about Nafplio</p>
 <div class="more-info-content">
 <p><strong>First Capital:</strong> Nafplio was the first capital of modern Greece from 1829 to 1834, before Athens took over. The first Greek president was assassinated here.</p>
 <p><strong>Palamidi Fortress:</strong> The fortress above town has 999 steps (some say 857). Venetians built it in just three years, a remarkable feat of military engineering.</p>
 <p><strong>Bourtzi:</strong> The tiny castle on the island in the harbor served as an executioner's residence during Ottoman rule. Now it's one of Greece's most photographed monuments.</p>
 <p><strong>Venetian Legacy:</strong> Nafplio changed hands between Venetians, Ottomans, and Greeks multiple times. The architecture shows all three influences layered together.</p>
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/wandering-01.jpg" class="story-image" data-caption="The path to the fortress." alt="Wandering" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/wandering-02.jpg" class="story-image" data-caption="Climbing toward history." alt="Path to fortress" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">Following paths uphill through olive groves and Mediterranean scrub.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/found-fort-01.jpg" class="story-image" data-caption="The fortress appears." alt="Finding the fort" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/found-fort-02.jpg" class="story-image" data-caption="Ottoman walls." alt="Fort walls" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/fortress-agave.jpg" class="story-image" data-caption="Agave and fortress walls." alt="Fortress agave" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/fortress-walls-vegetation.jpg" class="story-image" data-caption="Walls and bougainvillea." alt="Fortress walls" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">Nature reclaiming the fortress - agave, bougainvillea, and pines against Ottoman stone.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/pylos/fortress-courtyard.jpg" class="story-image" data-caption="The fortress courtyard." alt="Fortress courtyard" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The main courtyard - cobblestone paths leading to the old barracks and storerooms.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/pylos/fortress-colonnade.jpg" class="story-image" data-caption="The arched colonnade." alt="Fortress colonnade" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/fortress-iron-door.jpg" class="story-image" data-caption="Iron door." alt="Fortress door" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/fortress-tunnel.jpg" class="story-image" data-caption="Stone passage." alt="Fortress tunnel" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">Iron doors and stone tunnels - exploring the fortress felt like stepping back centuries.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/fortress-stone-doorway.jpg" class="story-image" data-caption="Doorway with cypress." alt="Stone doorway" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/fortress-gateway.jpg" class="story-image" data-caption="The main gateway." alt="Stone archway" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/pylos/fortress-mountain-view.jpg" class="story-image" data-caption="View from the fortress." alt="Mountain view" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/pylos/fortress-ramparts.jpg" class="story-image" data-caption="The ramparts overlooking the bay." alt="Fortress ramparts" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/pylos/fortress-battlements.jpg" class="story-image" data-caption="Battlements framing the bay." alt="Battlements" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/pylos/sea-arch-islands.jpg" class="story-image" data-caption="Sea arches and rocky islands." alt="Sea arch" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Rocky islands with natural sea arches - a landscape unchanged since the Odyssey.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/pylos/fortress-bay-view.jpg" class="story-image" data-caption="The bay from the heights." alt="Bay view" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/town-from-fortress.jpg" class="story-image" data-caption="Town view from the fortress." alt="Town view" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/town-oleander.jpg" class="story-image" data-caption="Streets lined with oleander." alt="Town street" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 <p class="photo-caption-inline">Pylos town - white houses and terracotta roofs against the green hillside.</p>
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/flowers-01.jpg" class="story-image" data-caption="Bougainvillea." alt="Flowers" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/flowers-02.jpg" class="story-image" data-caption="Mediterranean color." alt="Bougainvillea" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/gyro-lunch.jpg" class="story-image" data-caption="Greek lunch." alt="Gyro lunch" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/pylos/image-20.jpg" class="story-image" data-caption="The waterfront." alt="Pylos harbor" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Ravenna' : '+ More about Ravenna'">+ More about Ravenna</p>
 <div class="more-info-content">
 <p><strong>Byzantine Mosaics:</strong> Ravenna's churches contain the finest Byzantine mosaics outside Istanbul. Eight buildings are UNESCO World Heritage sites.</p>
 <p><strong>Three Capitals:</strong> Ravenna served as capital of the Western Roman Empire, the Ostrogothic Kingdom, and the Byzantine Exarchate - all between 402 and 751 AD.</p>
 <p><strong>Dante's Tomb:</strong> Dante Alighieri died here in 1321 and is buried in Ravenna. Florence has been trying to get his bones back for 700 years.</p>
 <p><strong>Lost Port:</strong> Ravenna was once a major Roman naval base with direct access to the sea. The coastline has since shifted 10 kilometers eastward.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/sibenik/sibenik-hero" class="story-image" alt="Šibenik old town" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/sibenik/sibenik-port-01" class="inline-image" data-caption="Walking from the port into town." alt="Port approach" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/sibenik/sibenik-port-02" class="inline-image" data-caption="The harbor stretches along the coast." alt="Harbor view" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>

 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/sibenik/sibenik-port-03" class="inline-image" data-caption="First glimpse of the old town rising above." alt="Old town from port" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/sibenik/sibenik-port-04" class="inline-image" data-caption="Stone facades and Adriatic light." alt="Stone buildings" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/sibenik/sibenik-oldtown-01" class="inline-image" data-caption="Into the medieval streets." alt="Old town street" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/sibenik/sibenik-oldtown-02" class="inline-image" data-caption="Every corner a new discovery." alt="Old town corner" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>

 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/sibenik/sibenik-oldtown-03" class="inline-image" data-caption="Stone worn smooth by centuries of footsteps." alt="Stone streets" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/sibenik/sibenik-oldtown-04" class="inline-image" data-caption="The old town unfolds in layers." alt="Old town layers" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/sibenik/sibenik-streets-01" class="inline-image" data-caption="Just how old were these streets?" alt="Ancient streets" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/sibenik/sibenik-streets-02" class="inline-image" data-caption="Knights and warriors once walked here." alt="Historic streets" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/sibenik/sibenik-food-01" class="inline-image" data-caption="The search for food - always an adventure." alt="Food search" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/sibenik/sibenik-food-02" class="inline-image" data-caption="Croatian cuisine to restore the spirit." alt="Croatian food" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Šibenik' : '+ More about Šibenik'">+ More about Šibenik</p>
 <div class="more-info-content">
 <p><strong>UNESCO Cathedral:</strong> The Cathedral of St. James is a UNESCO World Heritage site, built entirely of stone over 100 years without using any wood or brick.</p>
 <p><strong>Croatian Origin:</strong> Šibenik is the oldest native Croatian town on the Adriatic - founded by Croats rather than Greeks or Romans.</p>
 <p><strong>Krka Falls:</strong> Nearby Krka National Park features stunning waterfalls where you can swim. It's one of Croatia's most beautiful natural attractions.</p>
 <p><strong>Game of Thrones:</strong> St. Nicholas Fortress doubled as the Iron Bank of Braavos in Game of Thrones. Several scenes were filmed throughout the town.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/zakynthos/IMG_1378" class="story-image" data-caption="The harbor of Zakynthos town." alt="Zakynthos harbor" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/zakynthos/IMG_1376" class="story-image" data-caption="Yacht marina with hillside town." alt="Marina view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/zakynthos/IMG_1384" class="story-image" data-caption="Main square with statue and neoclassical building." alt="Town square" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The main square - neoclassical elegance meets Mediterranean ease.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/zakynthos/IMG_1382" class="story-image" data-caption="Palm-lined square with monument." alt="Town square palms" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/zakynthos/IMG_1394" class="story-image" data-caption="Orthodox church exterior with golden mosaics." alt="Church exterior" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Golden mosaics glint above the entrance - a hint of the treasures inside.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/zakynthos/IMG_1398" class="story-image" data-caption="Church interior with frescoes and chandeliers." alt="Church interior" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/zakynthos/IMG_1400" class="story-image" data-caption="Detail of frescoes and colorful stained glass windows." alt="Fresco detail" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/zakynthos/IMG_1390" class="story-image" data-caption="Souvlaki with oregano fries." alt="Greek food" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_80,f_auto/shiplife/itea/itea-deck-smoke-01" class="story-image" data-caption="First one on deck - smoke rising everywhere." alt="Deck view with smoke" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_80,f_auto/shiplife/itea/itea-town-smoke" class="story-image" data-caption="The whole town roasting lamb - smoke from every rooftop." alt="Town with Easter smoke" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/itea/itea-church-01" class="inline-image" data-caption="Lamb on the spit - the source of all that smoke." alt="Lamb roasting" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/itea/itea-church-02" class="inline-image" data-caption="Invitations to drink and celebrate with the locals." alt="Drinking with locals" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/itea/itea-church-03" class="inline-image" data-caption="Greek Orthodox churches on Easter morning." alt="Church" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/itea/itea-scene-01" class="inline-image" data-caption="Centuries of faith built into stone." alt="Church" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/itea/itea-resistance-memorial" class="inline-image" data-caption="Memorial to the National Resistance, 1941-1944." alt="Resistance memorial" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/itea/itea-war-memorial" class="inline-image" data-caption="Magnanimous Mother - in pain and in glory." alt="War memorial" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_80,f_auto/shiplife/semarang/semarang-borobudur-temple-01" class="story-image" data-caption="Ready to explore - conical hat borrowed from a vendor." alt="At the temple base" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_80,f_auto/shiplife/semarang/semarang-borobudur-temple-04" class="story-image" data-caption: "Relief panel detail - a thousand years old, still telling stories." alt="Relief panels" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_80,f_auto/shiplife/semarang/semarang-borobudur-temple-03" class="story-image" data-caption="Walking the relief-lined corridors." alt="Temple corridors" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/semarang/semarang-borobudur-temple-05" class="inline-image" data-caption="Guide explaining the upper terraces." alt="Guide at stupas" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/semarang/semarang-borobudur-temple-06" class="inline-image" data-caption="Among the bell-shaped stupas." alt="At the stupas" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_80,f_auto/shiplife/semarang/semarang-borobudur-temple-02" class="story-image" data-caption="Looking out over the Javanese plains." alt="View from temple" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_80,f_auto/shiplife/semarang/semarang-borobudur-temple-07" class="story-image" data-caption="Gamelan orchestra with wayang puppets in the background." alt="Gamelan musicians" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768865640/IMG_20131113_105615_yzzp1y.jpg" class="story-image" data-caption="Temple gate in Phuket." alt="Temple gate, Phuket" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768866121/IMG_19700105_041151_dliaia.jpg" class="story-image" data-caption="My good friends Martin Neely and Yolonda Barber - Martin is the reason I'm still here to tell this story." alt="Martin Neely and Yolonda Barber" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768865557/PANO_20131118_134025_qd3r7o.jpg" class="story-image" data-caption="Beach day panorama - Phuket." alt="Phuket beach panorama" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The Phuket you're supposed to remember.</p>
 
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768865556/IMG_20131118_135639_wcs0ae.jpg" class="story-image" data-caption="Fresh fruit cart - Phuket streets." alt="Fruit cart" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768865556/IMG_20131118_164928_wge65r.jpg" class="story-image" data-caption="Patong Beach entrance at evening." alt="Patong Beach entrance" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/v1768865557/PANO_20131118_182257_b9tvli.jpg" class="story-image" data-caption="Sunset over Phuket." alt="Phuket sunset panorama" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Sunset over the Andaman Sea.</p>
 
 <div class="story-gallery-grid">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768865679/IMG_20131118_184137_1_toim78.jpg" class="story-image" data-caption="Making friends with the local wildlife." alt="Derrick with iguana" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/v1768865556/IMG_20131118_184140_zmbgko.jpg" class="story-image" data-caption="Another day in paradise." alt="Phuket evening" onclick="openLightbox(this.src.replace('w_400', 'w_1600'))" style="cursor:pointer">
 </div>
 </div>
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/castro/castro-sail-01" class="inline-image" data-caption="Mussel farms dot the waters of Chiloé." alt="Mussel farms" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/castro/castro-sail-02" class="inline-image" data-caption="Green Patagonian hillsides." alt="Patagonian landscape" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/castro/castro-sail-03" class="story-image" data-caption="Castro from the water." alt="Castro town" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Castro emerging from the mist - the yellow church marking the heart of town.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/castro/castro-sail-04" class="story-image" data-caption="The UNESCO wooden church of Castro." alt="Wooden church" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/castro/castro-sail-05" class="story-image" data-caption="Colorful streets leading to the waterfront." alt="Castro streets" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/cairo/cairo-city-01" class="inline-image" data-caption="Through the streets of Cairo." alt="Cairo streets" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/cairo/cairo-alahram" class="inline-image" data-caption="Al-Ahram Building - Egypt's most prominent newspaper." alt="Al-Ahram" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>

 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/cairo/cairo-city-02" class="inline-image" data-caption="Cairo." alt="Cairo" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/cairo/cairo-city-03" class="inline-image" data-caption="On the way to the pyramids." alt="Cairo" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>

 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/cairo/cairo-desert-01" class="story-image" data-caption="Where the desert begins." alt="Desert" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">

 <h3>The Approach</h3>
 <p>And then, there it was - that first glimpse of the pyramids rising from the sand.</p>

 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/cairo/cairo-hero" class="inline-image" data-caption="First glimpse." alt="First glimpse" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/cairo/cairo-approach-01" class="inline-image" data-caption="The closer we came, the further they seemed." alt="Approaching" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/cairo/cairo-scale-01" class="story-image" data-caption="People like ants - the scale finally hits you." alt="Scale of pyramids" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">

 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/cairo/cairo-pyramids-01" class="inline-image" data-caption="The Pyramids of Giza." alt="Pyramids" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/cairo/cairo-pyramids-02" class="inline-image" data-caption="4,500 years of history." alt="Pyramids" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>

 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/cairo/cairo-staging" class="story-image" data-caption="The staging area." alt="Staging area" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">

 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/cairo/cairo-pyramids-03" class="inline-image" data-caption="Ancient wonder." alt="Pyramids" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/cairo/cairo-pyramids-04" class="inline-image" data-caption="Giza plateau." alt="Pyramids" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>

 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/cairo/cairo-pyramids-05" class="inline-image" data-caption="Standing before the ages." alt="Pyramids" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/cairo/cairo-pyramids-06" class="inline-image" data-caption="The Great Pyramid." alt="Pyramids" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>

 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1000,q_80,f_auto/shiplife/cairo/cairo-final" class="story-image" data-caption="Leaving Giza." alt="Leaving" onclick="openLightbox(this.src.replace('w_1000', 'w_1600'))" style="cursor:pointer">
 ...
 richContent: `
 <div class="story-header">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1200,q_80,f_auto/shiplife/buenos-aires/buenos-aires-hero" class="story-image" alt="Buenos Aires" onclick="openLightbox(this.src.replace('w_1200', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/buenos-aires/buenos-aires-walk-01" class="inline-image" data-caption="Exploring the city on foot." alt="Walking" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/buenos-aires/buenos-aires-walk-02" class="inline-image" data-caption="European architecture, South American soul." alt="Architecture" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/buenos-aires/buenos-aires-walk-03" class="inline-image" data-caption="Hunting for wifi and coffee." alt="Street scene" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/buenos-aires/buenos-aires-walk-04" class="inline-image" data-caption="The Paris of the South." alt="Boulevard" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>
 ...
 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/buenos-aires/buenos-aires-downtown-01" class="inline-image" data-caption="Downtown bustle." alt="Downtown" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/buenos-aires/buenos-aires-downtown-02" class="inline-image" data-caption="City life in motion." alt="City life" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>

 <div class="image-row-2">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/buenos-aires/buenos-aires-downtown-03" class="inline-image" data-caption="Finding our way." alt="Street" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_600,q_80,f_auto/shiplife/buenos-aires/buenos-aires-downtown-04" class="inline-image" data-caption="Another day, another city." alt="Buenos Aires" onclick="openLightbox(this.src.replace('w_600', 'w_1600'))" style="cursor:pointer">
 </div>

 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Buenos Aires' : '+ More about Buenos Aires'">+ More about Buenos Aires</p>
 <div class="more-info-content">
 <p><strong>Birthplace of Tango:</strong> Tango originated in the working-class neighborhoods of Buenos Aires in the late 1800s. It began in the conventillos (tenement houses) where immigrants gathered.</p>
 <p><strong>Therapy Capital:</strong> Buenos Aires has more psychologists per capita than any other city in the world. Porteños (locals) consider therapy as normal as going to the dentist.</p>
 <p><strong>Recoleta Cemetery:</strong> One of the world's most beautiful cemeteries, Recoleta is the final resting place of Eva Perón. Her tomb is the most visited spot in the entire cemetery.</p>
 <p><strong>La Boca:</strong> The colorful buildings of La Boca were painted with leftover ship paint by Italian immigrants. Each house is a patchwork of whatever colors were available.</p>
 </div>
...
an original composition inspired by this place.
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/ponza/IMG_5165" class="story-image" data-caption="Ponza's volcanic profile rising from the Tyrrhenian Sea." alt="Ponza island approach" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The island's volcanic profile emerges as you approach - white cliffs and green hills.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/ponza/IMG_5210" class="story-image" data-caption="The Seabourn anchored off Ponza's cliffs." alt="Ship at anchor" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/ponza/IMG_5214" class="story-image" data-caption="Roman grottoes carved into Ponza's volcanic cliffs." alt="Roman grottoes" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/ponza/IMG_5205" class="story-image" data-caption="Village street with church dome." alt="Ponza village" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Every corner reveals another view - church domes, sea glimpses, lives lived slowly.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/ponza/IMG_5190" class="story-image" data-caption="Ponza's dramatic coastline and bays." alt="Coastal view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/ponza/IMG_5197" class="story-image" data-caption="Clifftop cemetery with sea views." alt="Cemetery and sea" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The dead have the best views on Ponza - sea and sky forever.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/ponza/IMG_5203" class="story-image" data-caption="Rock-cut tombs beneath the lighthouse." alt="Rock tombs" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/lipari/IMG_5156" class="story-image" data-caption="Tall ship seen from the Seabourn deck." alt="Tall ship" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Two worlds meeting - the Seabourn's deck and a tall ship against the volcanic hills.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/lipari/20150518_113809" class="story-image" data-caption="The Seabourn Odyssey from shore." alt="Seabourn from shore" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/lipari/20150518_105801" class="story-image" data-caption="Aeolus sculpture on the Lipari waterfront." alt="Aeolus sculpture" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Aeolus in iron - the wind god who ruled these islands in myth.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/lipari/20150518_105329" class="story-image" data-caption="Volcanic rocks and crashing waves." alt="Volcanic shore" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/lipari/20150518_110104" class="story-image" data-caption="Lipari waterfront promenade." alt="Waterfront" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The waterfront promenade - ivy-covered buildings and the sea never far away.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/lipari/20150518_114416" class="story-image" data-caption="Lipari harbor panorama." alt="Harbor view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/lipari/20150518_114633" class="story-image" data-caption="Town street with hotels." alt="Town street" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Hotel Carasco and the main street - island life at its most relaxed.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/lipari/20150518_114833" class="story-image" data-caption="Hotel Sabbie D'Oro." alt="Hotel sign" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/amalfi/img_7021" class="story-image" data-caption="Harbor promenade with flowers." alt="Harbor view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Flowers line the promenade, the town climbing the cliffs behind.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/amalfi/img_7004" class="story-image" data-caption="Colorful buildings against dramatic cliffs." alt="Cliff architecture" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Pastel buildings cling to impossible cliffs - laundry drying in the Mediterranean sun.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/amalfi/img_7022" class="story-image" data-caption="Amalfi coastline." alt="Coastal view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/amalfi/img_6993" class="story-image" data-caption="Steep streets climbing the cliffside." alt="Steep street" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The streets climb straight up - scooters parked impossibly, buildings carved into rock.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/amalfi/img_6995" class="story-image" data-caption="Town architecture." alt="Town view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/amalfi/img_7009" class="story-image" data-caption="Local architecture." alt="Buildings" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/20150609_123556" class="story-image" data-caption="Approaching Sorrento." alt="Sorrento approach" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The cliffs rise impossibly high - hotels and villas perched on the edge.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_5763" class="story-image" data-caption="Sorrento coastline." alt="Coastline" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The famous coastline stretches toward Positano and Amalfi.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_0872" class="story-image" data-caption="Harbor view." alt="Harbor" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Marina Piccola - where ferries depart for Capri beneath the clifftop hotels.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_5765" class="story-image" data-caption="Town view." alt="Town" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The town perches high above the water - a cascade of terracotta and pastel.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/20150804_114120" class="story-image" data-caption="Coastal panorama." alt="Panorama" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_5766" class="story-image" data-caption="Restaurant courtyard." alt="Restaurant" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">A table in a hidden courtyard - stone walls, white tablecloths, surrender.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/20150804_123310" class="story-image" data-caption="Local cuisine." alt="Food" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Fresh mozzarella, tomatoes still warm from the sun, local wine.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_5771" class="story-image" data-caption="Street scene." alt="Street" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The scent of lemons everywhere - this is limoncello country.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_0880" class="story-image" data-caption="Market scene." alt="Market" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The markets overflow - peppers, lemons, tomatoes piled high.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_0894" class="story-image" data-caption="Fruit market." alt="Fruit market" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">La fragola - strawberries, oranges, the colors of the coast.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_0902" class="story-image" data-caption="Pastry display." alt="Pastries" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Pastries for breakfast. And maybe second breakfast.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_0905" class="story-image" data-caption="Gelato." alt="Gelato" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Gelato mid-morning. Then again mid-afternoon. It's research.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_0909" class="story-image" data-caption="Food scene." alt="Food" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">By evening I'd eaten more than the previous week combined.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_0903" class="story-image" data-caption="Italian treats." alt="Treats" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_5779" class="story-image" data-caption="Old town street." alt="Street" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_0913" class="story-image" data-caption="Walking the streets." alt="Walking" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The kind of Italy that existed before the guidebooks arrived.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_0914" class="story-image" data-caption="Sorrento views." alt="Views" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_0917" class="story-image" data-caption="Piazza scene." alt="Piazza" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The main piazza - the heartbeat of Sorrento.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_0919" class="story-image" data-caption="Town square." alt="Square" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Named for the Renaissance poet Torquato Tasso, born here in 1544.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_0922" class="story-image" data-caption="Local gathering." alt="Gathering" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Espresso, conversation, the rhythm of Italian life.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_0923" class="story-image" data-caption="Evening scene." alt="Evening" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">As evening comes, the passeggiata begins.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_0926" class="story-image" data-caption="Town life." alt="Town life" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_1031" class="story-image" data-caption="Peninsula view." alt="Peninsula" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_1078" class="story-image" data-caption="Exploration." alt="Exploration" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Writers, artists, composers - they all fell for these views.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_1082" class="story-image" data-caption="Panorama." alt="Panorama" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The bay curves away toward Naples and Vesuvius.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_1095" class="story-image" data-caption="Coast view." alt="Coast view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">A reminder that this beautiful coast exists on borrowed time.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_1097" class="story-image" data-caption="Sorrento vista." alt="Vista" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_5002" class="story-image" data-caption="Return trip." alt="Return" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Sorrento never disappoints.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_5006" class="story-image" data-caption="Final image." alt="Final" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/sorrento/img_1041" class="story-image" data-caption="The Valley of the Mills - the image that called to me before I even knew I'd get there." alt="Valle dei Mulini" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portoferraio/town_panorama_pilot_boat" class="story-image" alt="Portoferraio harbor" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portoferraio/forte_stella_golden" class="story-image" alt="Forte Stella in golden light" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portoferraio/forte_stella" class="story-image" alt="Forte Stella" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portoferraio/archway_street" class="story-image" alt="Archway framing street" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/portoferraio/turquoise_beach" class="story-image" alt="Turquoise beach" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
...
an original composition inspired by this place.
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/antibes/20150816_103313" class="story-image" data-caption="Olives in every variety at the Antibes market." alt="Olive stall" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/antibes/20150820_103348" class="story-image" data-caption="Market atmosphere." alt="Market scene" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The morning light streaming through the market stalls.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/antibes/20150820_105943" class="story-image" data-caption="Local goods." alt="Local goods" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">This is what the French mean by "terroir" - the taste of a place.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/antibes/antibes_market" class="story-image" data-caption="Spices of Provence." alt="Spice stall" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/antibes/20150820_094258" class="story-image" data-caption="Ceramic map of Antibes." alt="Tile map" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">A ceramic map of the old town - every street a story.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/antibes/20150816_140928" class="story-image" data-caption="Antibes scene." alt="Town view" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The Côte d'Azur light that drew Picasso and countless others.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/antibes/20150818_155645" class="story-image" data-caption="Old town." alt="Old town" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Narrow streets where every corner hides a café or gallery.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/antibes/20150820_105951" class="story-image" data-caption="Town detail." alt="Town detail" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The kind of place that makes you forget the rest of the world.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/antibes/20150820_120958" class="story-image" data-caption="Town architecture." alt="Architecture" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Mediterranean architecture at its finest.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/antibes/antibes_watchtower" class="story-image" data-caption="The watchtower of Antibes." alt="Watchtower" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">The old watchtower - keeping guard over the Côte d'Azur since the Middle Ages.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/antibes/20150820_214933" class="story-image" data-caption="Night panorama of the Côte d'Azur from the ship." alt="Night panorama" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/fiji/fiji_hardrock" class="story-image" data-caption="The staff at Hard Rock Cafe Port Denarau performing for the crowd." alt="Hard Rock Cafe performance" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <div class="image-row">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/fiji/fiji_138" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/fiji/fiji_138" data-caption="Fresh catch at the market" alt="Fish market" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/fiji/fiji_138')" style="cursor:pointer">
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_400,q_auto,f_auto/shiplife/fiji/fiji_149" class="inline-image" data-full="https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/fiji/fiji_149" data-caption="Port Denarau marketplace" alt="Marketplace" onclick="openLightbox('https://res.cloudinary.com/de5jbyhxx/image/upload/w_1600,q_auto,f_auto/shiplife/fiji/fiji_149')" style="cursor:pointer">
 </div>
 ...
 <h3 class="section-title-panel">Island Time</h3>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/fiji/fiji_158" class="story-image" data-caption="Fiji Beach Resort & Spa - infinity pool overlooking the islands." alt="Resort pool" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Fiji' : '+ More about Fiji'">+ More about Fiji</p>
 <div class="more-info-content">
 <p><strong>333 Islands:</strong> Fiji consists of 333 islands, of which about 110 are permanently inhabited. The two largest are Viti Levu and Vanua Levu.</p>
 <p><strong>Bula Spirit:</strong> "Bula" is more than a greeting - it's a philosophy. Fijians use it to wish health, happiness, and life. You'll hear it dozens of times a day.</p>
 <p><strong>Kava Ceremony:</strong> Kava is central to Fijian culture. Made from ground root, the drink is mildly sedative and always shared in ceremony with visitors.</p>
 <p><strong>Rugby Nation:</strong> Fiji punches well above its weight in rugby sevens. The team won gold at the 2016 Olympics, the country's first-ever Olympic medal.</p>
 </div>
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/isle-of-pines/columnar_pines_island.jpg" class="story-image" alt="Columnar pines island" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/isle-of-pines/reef_through_pines.jpg" class="story-image" alt="Reef through pines" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/isle-of-pines/tropical_garden.jpg" class="story-image" alt="Tropical garden" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 <p class="photo-caption-inline">Tropical gardens with bougainvillea. Color everywhere.</p>
 <img src="https://res.cloudinary.com/de5jbyhxx/image/upload/w_800,q_auto,f_auto/shiplife/isle-of-pines/hilltop_panorama.jpg" class="story-image" alt="Hilltop panorama" onclick="openLightbox(this.src.replace('w_800', 'w_1600'))" style="cursor:pointer">
 ...
 <p class="more-info-toggle" onclick="this.nextElementSibling.classList.toggle('expanded'); this.textContent = this.nextElementSibling.classList.contains('expanded') ? '− Less about Perth' : '+ More about Perth'">+ More about Perth</p>
 <div class="more-info-content">
 <p><strong>Most Isolated:</strong> Perth is the most isolated major city in the world. The nearest city of comparable size is Adelaide, 2,700 kilometers away.</p>
 <p><strong>Fremantle:</strong> The port of Fremantle is where cruise ships dock, 20 kilometers from Perth CBD. It retains a bohemian character with heritage buildings and markets.</p>
 <p><strong>Rottnest Island:</strong> Just offshore lies Rottnest Island, home to quokkas - small marsupials famous for their photogenic "smiles." Dutch explorers mistook them for rats.</p>
 <p><strong>Mining Boom:</strong> Western Australia's mining industry made Perth one of the fastest-growing cities in the developed world. The wealth shows in the sleek skyline.</p>
 </div>
